...
(format: `.claude/plugins/sdd-suite/skills/sdd-qa/reference/defect-filing.md`).
...
report violates its own format (`.claude/plugins/sdd-suite/skills/sdd-qa/reference/defect-filing.md`) — stop and fix
