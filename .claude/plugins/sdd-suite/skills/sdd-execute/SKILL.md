...
3. **Build the integration PR body** by rendering `.claude/plugins/sdd-suite/skills/sdd-execute/templates/integration-pr-body.md`
...
Read `.claude/plugins/sdd-suite/skills/sdd-execute/templates/branch-sync.md` and execute the procedure,
...
Read `.claude/plugins/sdd-suite/skills/sdd-execute/templates/step-pr-body.md` for the PR body template.
...
5. Create PR (use the filled-in body from the template):
   ...
   gh pr create \
     ...
     --body "$(cat .claude/plugins/sdd-suite/skills/sdd-execute/templates/step-pr-body.md)"
   ```
