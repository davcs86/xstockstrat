...
`.claude/plugins/sdd-suite/skills/sdd-execute/reference/tdd-gate.md`.
...
failing run before the implementation step and the passing run after (`.claude/plugins/sdd-suite/skills/sdd-execute/reference/tdd-gate.md`). Both
