...
const (
	SizingMode_SIZING_MODE_UNSPECIFIED SizingMode = 0 // request default → the legacy serial per-symbol path
	SizingMode_SIZING_MODE_LEGACY      SizingMode = 1 // serial per-symbol compounding (the aggregate is Π(1+rᵢ)−1)
	SizingMode_SIZING_MODE_PORTFOLIO   SizingMode = 2 // one shared cash pool, concurrent positions, one equity curve
)
...
var (
	SizingMode_name = map[int32]string{
		...
		1: "SIZING_MODE_LEGACY",
		2: "SIZING_MODE_PORTFOLIO",
	}
	SizingMode_value = map[string]int32{
		"SIZING_MODE_UNSPECIFIED": 0,
		"SIZING_MODE_LEGACY":      1,
		"SIZING_MODE_PORTFOLIO":   2,
	}
)
...
type FillModel int32

const (
	FillModel_FILL_MODEL_UNSPECIFIED    FillModel = 0 // caller/config did not choose → resolves to SAME_BAR_CLOSE (legacy)
	FillModel_FILL_MODEL_SAME_BAR_CLOSE FillModel = 1 // legacy: fill at bar i's close ± slippage (optimistically biased)
	FillModel_FILL_MODEL_NEXT_BAR_OPEN  FillModel = 2 // bias-free: fill a bar-i signal at bar (i+1)'s open ± slippage
)

// Enum value maps for FillModel.
var (
	FillModel_name = map[int32]string{
		0: "FILL_MODEL_UNSPECIFIED",
		1: "FILL_MODEL_SAME_BAR_CLOSE",
		2: "FILL_MODEL_NEXT_BAR_OPEN",
	}
	FillModel_value = map[string]int32{
		"FILL_MODEL_UNSPECIFIED":    0,
		"FILL_MODEL_SAME_BAR_CLOSE": 1,
		"FILL_MODEL_NEXT_BAR_OPEN":  2,
	}
)

func (x FillModel) Enum() *FillModel {
	p := new(FillModel)
	*p = x
	return p
}

func (x FillModel) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FillModel) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[2].Descriptor()
}

func (FillModel) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[2]
}

func (x FillModel) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use FillModel.Descriptor instead.
func (FillModel) EnumDescriptor() ([]byte, []int) {
	return file_analysis_v1_analysis_proto_rawDescGZIP(), []int{2}
}

// The engine's decision for a single bar. Closed set → enum (C-04).
type BarAction int32

const (
	BarAction_BAR_ACTION_UNSPECIFIED BarAction = 0
	BarAction_BAR_ACTION_WARMUP      BarAction = 1 // bar within the strategy's warm-up window
	BarAction_BAR_ACTION_HOLD_FLAT   BarAction = 2 // flat, no entry this bar
	BarAction_BAR_ACTION_ENTER_LONG  BarAction = 3 // opened a long position this bar
	BarAction_BAR_ACTION_EXIT_LONG   BarAction = 4 // closed a long position this bar
	BarAction_BAR_ACTION_HOLD_LONG   BarAction = 5 // holding an existing long, no exit this bar
)

// Enum value maps for BarAction.
var (
	BarAction_name = map[int32]string{
		0: "BAR_ACTION_UNSPECIFIED",
		1: "BAR_ACTION_WARMUP",
		2: "BAR_ACTION_HOLD_FLAT",
		3: "BAR_ACTION_ENTER_LONG",
		4: "BAR_ACTION_EXIT_LONG",
		5: "BAR_ACTION_HOLD_LONG",
	}
	BarAction_value = map[string]int32{
		"BAR_ACTION_UNSPECIFIED": 0,
		"BAR_ACTION_WARMUP":      1,
		"BAR_ACTION_HOLD_FLAT":   2,
		"BAR_ACTION_ENTER_LONG":  3,
		"BAR_ACTION_EXIT_LONG":   4,
		"BAR_ACTION_HOLD_LONG":   5,
	}
)

func (x BarAction) Enum() *BarAction {
	p := new(BarAction)
	*p = x
	return p
}

func (x BarAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BarAction) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[3].Descriptor()
}

func (BarAction) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[3]
}

func (x BarAction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use BarAction.Descriptor instead.
func (BarAction) EnumDescriptor() ([]byte, []int) {
	return file_analysis_v1_analysis_proto_rawDescGZIP(), []int{3}
}

// Why a symbol produced zero trades. Closed set → enum (C-04).
type NoTradeReason int32

const (
	NoTradeReason_NO_TRADE_REASON_UNSPECIFIED          NoTradeReason = 0 // symbol traded, or not classified
...
var (
	NoTradeReason_name = map[int32]string{
		0: "NO_TRADE_REASON_UNSPECIFIED",
...
func (x NoTradeReason) Enum() *NoTradeReason {
	p := new(NoTradeReason)
	*p = x
	return p
}

func (x NoTradeReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (NoTradeReason) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[4].Descriptor()
}

func (NoTradeReason) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[4]
}

func (x NoTradeReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use NoTradeReason.Descriptor instead.
func (NoTradeReason) EnumDescriptor() ([]byte, []int) {
...
func (ComponentKind) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[5].Descriptor()
}

func (ComponentKind) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[5]
}
...
func (StrategyOperation) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[6].Descriptor()
}

func (StrategyOperation) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[6]
}
...
const (
	...
	Comparator_COMPARATOR_LT          Comparator = 1
	Comparator_COMPARATOR_LTE         Comparator = 2
	Comparator_COMPARATOR_GT          Comparator = 3
	Comparator_COMPARATOR_GTE         Comparator = 4
	Comparator_COMPARATOR_BETWEEN     Comparator = 5 // threshold <= x <= threshold_high
)
...
func (Comparator) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[7].Descriptor()
}

func (Comparator) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[7]
}
...
type ScreenKind int32

const (
	ScreenKind_SCREEN_KIND_UNSPECIFIED         ScreenKind = 0
	ScreenKind_SCREEN_KIND_FUNDAMENTAL         ScreenKind = 1 // a fundamental metric (metric_name)
	ScreenKind_SCREEN_KIND_TECHNICAL_FORMULA   ScreenKind = 2 // a custom formula (component)
	ScreenKind_SCREEN_KIND_TECHNICAL_INDICATOR ScreenKind = 3 // a built-in indicator (component)
	ScreenKind_SCREEN_KIND_SIGNAL              ScreenKind = 4 // source-weighted signal blend
)

// Enum value maps for ScreenKind.
var (
	ScreenKind_name = map[int32]string{
		0: "SCREEN_KIND_UNSPECIFIED",
		1: "SCREEN_KIND_FUNDAMENTAL",
		2: "SCREEN_KIND_TECHNICAL_FORMULA",
		3: "SCREEN_KIND_TECHNICAL_INDICATOR",
		4: "SCREEN_KIND_SIGNAL",
	}
	ScreenKind_value = map[string]int32{
		"SCREEN_KIND_UNSPECIFIED":         0,
		"SCREEN_KIND_FUNDAMENTAL":         1,
		"SCREEN_KIND_TECHNICAL_FORMULA":   2,
		"SCREEN_KIND_TECHNICAL_INDICATOR": 3,
		"SCREEN_KIND_SIGNAL":              4,
	}
)

func (x ScreenKind) Enum() *ScreenKind {
	p := new(ScreenKind)
	*p = x
	return p
}

func (x ScreenKind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ScreenKind) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[8].Descriptor()
}

func (ScreenKind) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[8]
}

func (x ScreenKind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ScreenKind.Descriptor instead.
func (ScreenKind) EnumDescriptor() ([]byte, []int) {
	return file_analysis_v1_analysis_proto_rawDescGZIP(), []int{8}
}

type ScreenResultStatus int32

const (
	ScreenResultStatus_SCREEN_RESULT_STATUS_UNSPECIFIED       ScreenResultStatus = 0
	ScreenResultStatus_SCREEN_RESULT_STATUS_OK                ScreenResultStatus = 1
	ScreenResultStatus_SCREEN_RESULT_STATUS_INSUFFICIENT_DATA ScreenResultStatus = 2
)

// Enum value maps for ScreenResultStatus.
var (
	ScreenResultStatus_name = map[int32]string{
		0: "SCREEN_RESULT_STATUS_UNSPECIFIED",
		1: "SCREEN_RESULT_STATUS_OK",
		2: "SCREEN_RESULT_STATUS_INSUFFICIENT_DATA",
	}
	ScreenResultStatus_value = map[string]int32{
...
func (x ScreenResultStatus) Enum() *ScreenResultStatus {
	p := new(ScreenResultStatus)
	*p = x
	return p
}

func (x ScreenResultStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ScreenResultStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[9].Descriptor()
}

func (ScreenResultStatus) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[9]
}

func (x ScreenResultStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ScreenResultStatus.Descriptor instead.
func (ScreenResultStatus) EnumDescriptor() ([]byte, []int) {
...
type OpportunityActionTag int32

const (
	OpportunityActionTag_OPPORTUNITY_ACTION_TAG_UNSPECIFIED OpportunityActionTag = 0
	OpportunityActionTag_OPPORTUNITY_ACTION_TAG_ENTER       OpportunityActionTag = 1 // buy signal, not currently held
	OpportunityActionTag_OPPORTUNITY_ACTION_TAG_ADD         OpportunityActionTag = 2 // buy signal, already held
	OpportunityActionTag_OPPORTUNITY_ACTION_TAG_REDUCE      OpportunityActionTag = 3 // sell signal, held (trim or exit — human decides)
)

// Enum value maps for OpportunityActionTag.
var (
	OpportunityActionTag_name = map[int32]string{
		0: "OPPORTUNITY_ACTION_TAG_UNSPECIFIED",
		1: "OPPORTUNITY_ACTION_TAG_ENTER",
		2: "OPPORTUNITY_ACTION_TAG_ADD",
		3: "OPPORTUNITY_ACTION_TAG_REDUCE",
	}
	OpportunityActionTag_value = map[string]int32{
...
func (x OpportunityActionTag) Enum() *OpportunityActionTag {
	p := new(OpportunityActionTag)
	*p = x
	return p
}

func (x OpportunityActionTag) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (OpportunityActionTag) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[10].Descriptor()
}

func (OpportunityActionTag) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[10]
}

func (x OpportunityActionTag) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use OpportunityActionTag.Descriptor instead.
func (OpportunityActionTag) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	ConditionState_CONDITION_STATE_PASS        ConditionState = 1 // leaf currently satisfied
	ConditionState_CONDITION_STATE_SOFT        ConditionState = 2 // within the soft-band of the threshold but not passing
	ConditionState_CONDITION_STATE_FAIL        ConditionState = 3 // not satisfied, outside the soft-band
)
...
var (
	ConditionState_name = map[int32]string{
		...
		1: "CONDITION_STATE_PASS",
		2: "CONDITION_STATE_SOFT",
		3: "CONDITION_STATE_FAIL",
	}
	ConditionState_value = map[string]int32{
		"CONDITION_STATE_UNSPECIFIED": 0,
		"CONDITION_STATE_PASS":        1,
		"CONDITION_STATE_SOFT":        2,
		"CONDITION_STATE_FAIL":        3,
	}
)
...
func (ConditionState) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[11].Descriptor()
}

func (ConditionState) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[11]
}
...
type ReadinessRule int32

const (
	ReadinessRule_READINESS_RULE_UNSPECIFIED ReadinessRule = 0 // server treats as ENTRY (back-compat default)
	ReadinessRule_READINESS_RULE_ENTRY       ReadinessRule = 1 // trace the entry_rule (ENTER candidates, watchlist readiness)
	ReadinessRule_READINESS_RULE_EXIT        ReadinessRule = 2 // trace the exit_rule (held REDUCE/ADD opportunities)
)

// Enum value maps for ReadinessRule.
var (
	ReadinessRule_name = map[int32]string{
		0: "READINESS_RULE_UNSPECIFIED",
		1: "READINESS_RULE_ENTRY",
		2: "READINESS_RULE_EXIT",
	}
	ReadinessRule_value = map[string]int32{
		"READINESS_RULE_UNSPECIFIED": 0,
		"READINESS_RULE_ENTRY":       1,
		"READINESS_RULE_EXIT":        2,
	}
)

func (x ReadinessRule) Enum() *ReadinessRule {
	p := new(ReadinessRule)
	*p = x
	return p
}

func (x ReadinessRule) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ReadinessRule) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[12].Descriptor()
}

func (ReadinessRule) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[12]
}

func (x ReadinessRule) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ReadinessRule.Descriptor instead.
func (ReadinessRule) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	ReadinessState_READINESS_STATE_RESOLVED    ReadinessState = 1 // `readiness` populated; served from the FAST cache path
	ReadinessState_READINESS_STATE_PENDING     ReadinessState = 2 // not-yet-fresh; a background refresh was kicked; poll again
	ReadinessState_READINESS_STATE_UNKNOWN     ReadinessState = 3 // data-unavailable (bar_epoch < 0 sentinel); best-effort retry
)
...
var (
	ReadinessState_name = map[int32]string{
		...
		1: "READINESS_STATE_RESOLVED",
		2: "READINESS_STATE_PENDING",
		3: "READINESS_STATE_UNKNOWN",
	}
	ReadinessState_value = map[string]int32{
		"READINESS_STATE_UNSPECIFIED": 0,
		"READINESS_STATE_RESOLVED":    1,
		"READINESS_STATE_PENDING":     2,
		"READINESS_STATE_UNKNOWN":     3,
	}
)
...
const (
	OpportunityAction_OPPORTUNITY_ACTION_UNSPECIFIED OpportunityAction = 0
	OpportunityAction_OPPORTUNITY_ACTION_SNOOZE      OpportunityAction = 1 // hide until snooze_until (bounded)
	OpportunityAction_OPPORTUNITY_ACTION_DISMISS     OpportunityAction = 2 // hide indefinitely
	OpportunityAction_OPPORTUNITY_ACTION_TAKE        OpportunityAction = 3 // user acted on it (feeds queue_share/taken reconciliation)
)

// Enum value maps for OpportunityAction.
var (
	OpportunityAction_name = map[int32]string{
		0: "OPPORTUNITY_ACTION_UNSPECIFIED",
		1: "OPPORTUNITY_ACTION_SNOOZE",
		2: "OPPORTUNITY_ACTION_DISMISS",
		3: "OPPORTUNITY_ACTION_TAKE",
	}
	OpportunityAction_value = map[string]int32{
		"OPPORTUNITY_ACTION_UNSPECIFIED": 0,
		"OPPORTUNITY_ACTION_SNOOZE":      1,
		"OPPORTUNITY_ACTION_DISMISS":     2,
		"OPPORTUNITY_ACTION_TAKE":        3,
	}
)
...
func (OpportunityAction) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[14].Descriptor()
}

func (OpportunityAction) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[14]
}
...
func (SnapshotEventType) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[15].Descriptor()
}

func (SnapshotEventType) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[15]
}
...
func (FactorType) Descriptor() protoreflect.EnumDescriptor {
	return file_analysis_v1_analysis_proto_enumTypes[16].Descriptor()
}

func (FactorType) Type() protoreflect.EnumType {
	return &file_analysis_v1_analysis_proto_enumTypes[16]
}
...
type RunBacktestRequest struct {
	...
	SizingMode SizingMode `protobuf:"varint,8,opt,name=sizing_mode,json=sizingMode,proto3,enum=xstockstrat.analysis.v1.SizingMode" json:"sizing_mode,omitempty"`
	...
	// existing callers.
	FillModel     FillModel `protobuf:"varint,9,opt,name=fill_model,json=fillModel,proto3,enum=xstockstrat.analysis.v1.FillModel" json:"fill_model,omitempty"`
...
func (x *RunBacktestRequest) GetSizingMode() SizingMode {
	if x != nil {
		return x.SizingMode
	}
...
func (x *RunBacktestRequest) GetFillModel() FillModel {
	if x != nil {
		return x.FillModel
	}
	return FillModel_FILL_MODEL_UNSPECIFIED
}
...
type BacktestResult struct {
	...
	Diagnostics      []*SymbolDiagnostics   `protobuf:"bytes,14,rep,name=diagnostics,proto3" json:"diagnostics,omitempty"`                       // per-bar debug data for every simulated symbol (feature 064)
	...
	SizingMode   SizingMode              `protobuf:"varint,17,opt,name=sizing_mode,json=sizingMode,proto3,enum=xstockstrat.analysis.v1.SizingMode" json:"sizing_mode,omitempty"` // the mode actually used (never UNSPECIFIED on a completed run)
	CapitalSkips []*PortfolioCapitalSkip `protobuf:"bytes,18,rep,name=capital_skips,json=capitalSkips,proto3" json:"capital_skips,omitempty"`                                    // portfolio mode only; empty in legacy
	...
	PortfolioEquityCurve []*EquityPoint `protobuf:"bytes,19,rep,name=portfolio_equity_curve,json=portfolioEquityCurve,proto3" json:"portfolio_equity_curve,omitempty"`
	// Effective fill model the run actually used (feature 151); never UNSPECIFIED on a completed run.
	FillModel     FillModel `protobuf:"varint,20,opt,name=fill_model,json=fillModel,proto3,enum=xstockstrat.analysis.v1.FillModel" json:"fill_model,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BacktestResult) GetDiagnostics() []*SymbolDiagnostics {
	if x != nil {
...
func (x *BacktestResult) GetInitialCapital() float64 {
	if x != nil {
		return x.InitialCapital
	}
	return 0
...
func (x *BacktestResult) GetSizingMode() SizingMode {
	if x != nil {
		return x.SizingMode
	}
	return SizingMode_SIZING_MODE_UNSPECIFIED
...
func (x *BacktestResult) GetCapitalSkips() []*PortfolioCapitalSkip {
	if x != nil {
		return x.CapitalSkips
	}
	return nil
}

func (x *BacktestResult) GetPortfolioEquityCurve() []*EquityPoint {
	if x != nil {
		return x.PortfolioEquityCurve
	}
	return nil
}

func (x *BacktestResult) GetFillModel() FillModel {
	if x != nil {
		return x.FillModel
	}
	return FillModel_FILL_MODEL_UNSPECIFIED
...
type PortfolioCapitalSkip struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Symbol         string                 `protobuf:"bytes,1,opt,name=symbol,proto3" json:"symbol,omitempty"`
	Timestamp      *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	IntendedWeight float64                `protobuf:"fixed64,3,opt,name=intended_weight,json=intendedWeight,proto3" json:"intended_weight,omitempty"` // position_weight × initial_capital the entry would have needed
	AvailableCash  float64                `protobuf:"fixed64,4,opt,name=available_cash,json=availableCash,proto3" json:"available_cash,omitempty"`    // cash on hand in the shared pool at that bar
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *PortfolioCapitalSkip) Reset() {
	*x = PortfolioCapitalSkip{}
	mi := &file_analysis_v1_analysis_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PortfolioCapitalSkip) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PortfolioCapitalSkip) ProtoMessage() {}

func (x *PortfolioCapitalSkip) ProtoReflect() protoreflect.Message {
	mi := &file_analysis_v1_analysis_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PortfolioCapitalSkip.ProtoReflect.Descriptor instead.
func (*PortfolioCapitalSkip) Descriptor() ([]byte, []int) {
	return file_analysis_v1_analysis_proto_rawDescGZIP(), []int{3}
}

func (x *PortfolioCapitalSkip) GetSymbol() string {
	if x != nil {
		return x.Symbol
	}
	return ""
...
func (x *PortfolioCapitalSkip) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *PortfolioCapitalSkip) GetIntendedWeight() float64 {
	if x != nil {
		return x.IntendedWeight
	}
	return 0
}

func (x *PortfolioCapitalSkip) GetAvailableCash() float64 {
	if x != nil {
...
func (x *EquityPoint) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
type BarDiagnostic struct {
	state       protoimpl.MessageState `protogen:"open.v1"`
	Symbol      string                 `protobuf:"bytes,1,opt,name=symbol,proto3" json:"symbol,omitempty"`
	BarIndex    int32                  `protobuf:"varint,2,opt,name=bar_index,json=barIndex,proto3" json:"bar_index,omitempty"`
	...
	Indicators  map[string]float64     `protobuf:"bytes,10,rep,name=indicators,proto3" json:"indicators,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"fixed64,2,opt,name=value"` // present-only: a series is absent during its warm-up
	Warmup      bool                   `protobuf:"varint,11,opt,name=warmup,proto3" json:"warmup,omitempty"`
	SignalScore float64                `protobuf:"fixed64,12,opt,name=signal_score,json=signalScore,proto3" json:"signal_score,omitempty"`
	Conviction  float64                `protobuf:"fixed64,13,opt,name=conviction,proto3" json:"conviction,omitempty"`
	Action      BarAction              `protobuf:"varint,14,opt,name=action,proto3,enum=xstockstrat.analysis.v1.BarAction" json:"action,omitempty"`
	// Portfolio value (cash + position * close) after this bar — the per-bar equity
	// point the time-based equity curve plots (feature 068).
	Equity        float64 `protobuf:"fixed64,15,opt,name=equity,proto3" json:"equity,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BarDiagnostic) Reset() {
	*x = BarDiagnostic{}
...
func (x *BarDiagnostic) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BarDiagnostic) ProtoMessage() {}

func (x *BarDiagnostic) ProtoReflect() protoreflect.Message {
	mi := &file_analysis_v1_analysis_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BarDiagnostic.ProtoReflect.Descriptor instead.
func (*BarDiagnostic) Descriptor() ([]byte, []int) {
	return file_analysis_v1_analysis_proto_rawDescGZIP(), []int{6}
}

func (x *BarDiagnostic) GetSymbol() string {
	if x != nil {
		return x.Symbol
	}
	return ""
...
func (x *BarDiagnostic) GetBarIndex() int32 {
	if x != nil {
		return x.BarIndex
	}
	return 0
...
func (x *BarDiagnostic) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *BarDiagnostic) GetOpen() float64 {
	if x != nil {
		return x.Open
	}
	return 0
...
func (x *BarDiagnostic) GetHigh() float64 {
	if x != nil {
		return x.High
	}
	return 0
...
func (x *BarDiagnostic) GetLow() float64 {
	if x != nil {
		return x.Low
	}
	return 0
...
func (x *BarDiagnostic) GetClose() float64 {
	if x != nil {
		return x.Close
	}
	return 0
...
func (x *BarDiagnostic) GetVolume() int64 {
	if x != nil {
		return x.Volume
	}
	return 0
...
func (x *BarDiagnostic) GetVwap() float64 {
	if x != nil {
		return x.Vwap
	}
	return 0
...
func (x *BarDiagnostic) GetIndicators() map[string]float64 {
	if x != nil {
		return x.Indicators
	}
	return nil
...
func (x *BarDiagnostic) GetWarmup() bool {
	if x != nil {
		return x.Warmup
	}
	return false
...
func (x *BarDiagnostic) GetSignalScore() float64 {
	if x != nil {
		return x.SignalScore
	}
	return 0
}

func (x *BarDiagnostic) GetConviction() float64 {
	if x != nil {
		return x.Conviction
	}
	return 0
...
func (x *BarDiagnostic) GetAction() BarAction {
	if x != nil {
		return x.Action
	}
	return BarAction_BAR_ACTION_UNSPECIFIED
}

func (x *BarDiagnostic) GetEquity() float64 {
	if x != nil {
		return x.Equity
	}
	return 0
...
type SymbolDiagnostics struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Symbol        string                 `protobuf:"bytes,1,opt,name=symbol,proto3" json:"symbol,omitempty"`
	Bars          []*BarDiagnostic       `protobuf:"bytes,2,rep,name=bars,proto3" json:"bars,omitempty"`
	NoTradeReason NoTradeReason          `protobuf:"varint,3,opt,name=no_trade_reason,json=noTradeReason,proto3,enum=xstockstrat.analysis.v1.NoTradeReason" json:"no_trade_reason,omitempty"`
	BarsTotal     int32                  `protobuf:"varint,4,opt,name=bars_total,json=barsTotal,proto3" json:"bars_total,omitempty"`
	WarmupBars    int32                  `protobuf:"varint,5,opt,name=warmup_bars,json=warmupBars,proto3" json:"warmup_bars,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SymbolDiagnostics) Reset() {
	*x = SymbolDiagnostics{}
...
func (x *SymbolDiagnostics) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SymbolDiagnostics) ProtoMessage() {}

func (x *SymbolDiagnostics) ProtoReflect() protoreflect.Message {
	mi := &file_analysis_v1_analysis_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SymbolDiagnostics.ProtoReflect.Descriptor instead.
func (*SymbolDiagnostics) Descriptor() ([]byte, []int) {
	return file_analysis_v1_analysis_proto_rawDescGZIP(), []int{7}
}

func (x *SymbolDiagnostics) GetSymbol() string {
	if x != nil {
		return x.Symbol
	}
	return ""
...
func (x *SymbolDiagnostics) GetBars() []*BarDiagnostic {
	if x != nil {
		return x.Bars
	}
	return nil
...
func (x *SymbolDiagnostics) GetNoTradeReason() NoTradeReason {
	if x != nil {
		return x.NoTradeReason
	}
	return NoTradeReason_NO_TRADE_REASON_UNSPECIFIED
}

func (x *SymbolDiagnostics) GetBarsTotal() int32 {
	if x != nil {
		return x.BarsTotal
	}
	return 0
...
func (x *SymbolDiagnostics) GetWarmupBars() int32 {
	if x != nil {
		return x.WarmupBars
	}
	return 0
...
func (x *StrategyScore) GetEvidenceSymbols() int32 {
	if x != nil {
		return x.EvidenceSymbols
	}
	return 0
}

func (x *StrategyScore) GetEvidenceDays() int32 {
	if x != nil {
		return x.EvidenceDays
	}
	return 0
}

func (x *StrategyScore) GetProvisional() bool {
	if x != nil {
...
type ListBacktestsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	StrategyId    string                 `protobuf:"bytes,1,opt,name=strategy_id,json=strategyId,proto3" json:"strategy_id,omitempty"`
	Limit         int32                  `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty"` // 0 → server default (most recent 20)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type BacktestRunSummary struct {
	...
	BacktestId       string                 `protobuf:"bytes,1,opt,name=backtest_id,json=backtestId,proto3" json:"backtest_id,omitempty"`
	StrategyId       string                 `protobuf:"bytes,2,opt,name=strategy_id,json=strategyId,proto3" json:"strategy_id,omitempty"`
	Status           BacktestStatus         `protobuf:"varint,3,opt,name=status,proto3,enum=xstockstrat.analysis.v1.BacktestStatus" json:"status,omitempty"`
	TotalReturn      float64                `protobuf:"fixed64,4,opt,name=total_return,json=totalReturn,proto3" json:"total_return,omitempty"`
	AnnualizedReturn float64                `protobuf:"fixed64,5,opt,name=annualized_return,json=annualizedReturn,proto3" json:"annualized_return,omitempty"`
	...
	OverallScore     float64                `protobuf:"fixed64,12,opt,name=overall_score,json=overallScore,proto3" json:"overall_score,omitempty"` // 0 when the run earned no score (e.g. INSUFFICIENT_DATA)
	Rating           string                 `protobuf:"bytes,13,opt,name=rating,proto3" json:"rating,omitempty"`                                   // "" when the run earned no score
	...
	SizingMode    SizingMode             `protobuf:"varint,17,opt,name=sizing_mode,json=sizingMode,proto3,enum=xstockstrat.analysis.v1.SizingMode" json:"sizing_mode,omitempty"` // capital-allocation model the run used (feature 150); UNSPECIFIED on pre-150 rows
	FillModel     FillModel              `protobuf:"varint,18,opt,name=fill_model,json=fillModel,proto3,enum=xstockstrat.analysis.v1.FillModel" json:"fill_model,omitempty"`     // fill model the run used (feature 151); UNSPECIFIED on pre-151 rows
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BacktestRunSummary) GetBacktestId() string {
	if x != nil {
		return x.BacktestId
	}
	return ""
...
func (x *BacktestRunSummary) GetStrategyId() string {
	if x != nil {
		return x.StrategyId
	}
	return ""
...
func (x *BacktestRunSummary) GetStatus() BacktestStatus {
	if x != nil {
		return x.Status
	}
	return BacktestStatus_BACKTEST_STATUS_UNSPECIFIED
...
func (x *BacktestRunSummary) GetAnnualizedReturn() float64 {
	if x != nil {
		return x.AnnualizedReturn
	}
	return 0
...
func (x *BacktestRunSummary) GetProfitFactor() float64 {
	if x != nil {
		return x.ProfitFactor
	}
	return 0
...
func (x *BacktestRunSummary) GetSymbols() []string {
	if x != nil {
		return x.Symbols
	}
	return nil
...
func (x *BacktestRunSummary) GetOverallScore() float64 {
	if x != nil {
		return x.OverallScore
	}
	return 0
...
func (x *BacktestRunSummary) GetRating() string {
	if x != nil {
		return x.Rating
	}
	return ""
...
func (x *BacktestRunSummary) GetCompletedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CompletedAt
	}
	return nil
...
func (x *BacktestRunSummary) GetRangeStart() *timestamppb.Timestamp {
	if x != nil {
		return x.RangeStart
	}
	return nil
...
func (x *BacktestRunSummary) GetRangeEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.RangeEnd
	}
	return nil
...
func (x *BacktestRunSummary) GetSizingMode() SizingMode {
	if x != nil {
		return x.SizingMode
	}
	return SizingMode_SIZING_MODE_UNSPECIFIED
...
func (x *BacktestRunSummary) GetFillModel() FillModel {
	if x != nil {
		return x.FillModel
	}
	return FillModel_FILL_MODEL_UNSPECIFIED
...
type ListBacktestsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Runs          []*BacktestRunSummary  `protobuf:"bytes,1,rep,name=runs,proto3" json:"runs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListBacktestsResponse) GetRuns() []*BacktestRunSummary {
	if x != nil {
		return x.Runs
	}
	return nil
...
func (x *ManageStrategyRequest) GetUpdateMask() *fieldmaskpb.FieldMask {
	if x != nil {
		return x.UpdateMask
	}
	return nil
...
type ScreenCriterion struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RefName       string                 `protobuf:"bytes,1,opt,name=ref_name,json=refName,proto3" json:"ref_name,omitempty"`
	Kind          ScreenKind             `protobuf:"varint,2,opt,name=kind,proto3,enum=xstockstrat.analysis.v1.ScreenKind" json:"kind,omitempty"`
	MetricName    string                 `protobuf:"bytes,3,opt,name=metric_name,json=metricName,proto3" json:"metric_name,omitempty"` // FUNDAMENTAL only (e.g. "pe_ratio")
	Component     *StrategyComponent     `protobuf:"bytes,4,opt,name=component,proto3" json:"component,omitempty"`                     // reused, for TECHNICAL_* kinds
	Op            Comparator             `protobuf:"varint,5,opt,name=op,proto3,enum=xstockstrat.analysis.v1.Comparator" json:"op,omitempty"`
	Threshold     float64                `protobuf:"fixed64,6,opt,name=threshold,proto3" json:"threshold,omitempty"`
	ThresholdHigh float64                `protobuf:"fixed64,7,opt,name=threshold_high,json=thresholdHigh,proto3" json:"threshold_high,omitempty"` // for COMPARATOR_BETWEEN
	Weight        float64                `protobuf:"fixed64,8,opt,name=weight,proto3" json:"weight,omitempty"`                                    // contribution to the blended score
	HardFilter    bool                   `protobuf:"varint,9,opt,name=hard_filter,json=hardFilter,proto3" json:"hard_filter,omitempty"`           // true → failing this excludes the symbol
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ScreenCriterion) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ScreenCriterion) GetKind() ScreenKind {
	if x != nil {
		return x.Kind
	}
	return ScreenKind_SCREEN_KIND_UNSPECIFIED
}

func (x *ScreenCriterion) GetMetricName() string {
	if x != nil {
		return x.MetricName
	}
	return ""
...
func (x *ScreenCriterion) GetComponent() *StrategyComponent {
	if x != nil {
		return x.Component
	}
	return nil
...
func (x *ScreenCriterion) GetOp() Comparator {
	if x != nil {
		return x.Op
	}
...
func (x *ScreenCriterion) GetThreshold() float64 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
func (x *ScreenCriterion) GetThresholdHigh() float64 {
	if x != nil {
...
func (x *ScreenCriterion) GetWeight() float64 {
	if x != nil {
		return x.Weight
	}
	return 0
...
func (x *ScreenCriterion) GetHardFilter() bool {
	if x != nil {
		return x.HardFilter
	}
	return false
...
type ScreenResult struct {
	...
	CriterionScores map[string]float64     `protobuf:"bytes,3,rep,name=criterion_scores,json=criterionScores,proto3" json:"criterion_scores,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"fixed64,2,opt,name=value"` // per ref_name; skipped criteria are absent
	Passed          bool                   `protobuf:"varint,4,opt,name=passed,proto3" json:"passed,omitempty"`
	Status          ScreenResultStatus     `protobuf:"varint,5,opt,name=status,proto3,enum=xstockstrat.analysis.v1.ScreenResultStatus" json:"status,omitempty"`
	Gap             *CoverageGap           `protobuf:"bytes,6,opt,name=gap,proto3" json:"gap,omitempty"` // populated when status == INSUFFICIENT_DATA
	...
	Pe        float64 `protobuf:"fixed64,7,opt,name=pe,proto3" json:"pe,omitempty"`
	Rsi       float64 `protobuf:"fixed64,8,opt,name=rsi,proto3" json:"rsi,omitempty"`
	Atr       float64 `protobuf:"fixed64,9,opt,name=atr,proto3" json:"atr,omitempty"`
	RevGrowth float64 `protobuf:"fixed64,10,opt,name=rev_growth,json=revGrowth,proto3" json:"rev_growth,omitempty"`
...
func (x *ScreenResult) GetScore() float64 {
	if x != nil {
		return x.Score
	}
	return 0
...
func (x *ScreenResult) GetCriterionScores() map[string]float64 {
	if x != nil {
		return x.CriterionScores
	}
	return nil
}

func (x *ScreenResult) GetPassed() bool {
	if x != nil {
		return x.Passed
	}
	return false
...
func (x *ScreenResult) GetStatus() ScreenResultStatus {
	if x != nil {
		return x.Status
	}
	return ScreenResultStatus_SCREEN_RESULT_STATUS_UNSPECIFIED
}

func (x *ScreenResult) GetGap() *CoverageGap {
	if x != nil {
		return x.Gap
	}
	return nil
...
func (x *ScreenResult) GetPe() float64 {
	if x != nil {
		return x.Pe
	}
	return 0
...
func (x *ScreenResult) GetRsi() float64 {
	if x != nil {
		return x.Rsi
	}
	return 0
...
func (x *ScreenResult) GetAtr() float64 {
	if x != nil {
		return x.Atr
	}
	return 0
...
func (x *ScreenResult) GetRevGrowth() float64 {
	if x != nil {
		return x.RevGrowth
	}
	return 0
...
func (x *ScreenResult) GetHeld() bool {
	if x != nil {
		return x.Held
	}
	return false
...
func (x *ScreenResult) GetCriterionRawValues() map[string]float64 {
	if x != nil {
		return x.CriterionRawValues
	}
	return nil
}

func (x *ScreenResult) GetCriterionPassed() map[string]bool {
	if x != nil {
...
type ScreenSymbolsRequest struct {
	...
	Criteria []*ScreenCriterion     `protobuf:"bytes,2,rep,name=criteria,proto3" json:"criteria,omitempty"`
	// Blend params — same names the extracted scoring module reads (kept consistent with backtest).
	SignalSources   []string `protobuf:"bytes,3,rep,name=signal_sources,json=signalSources,proto3" json:"signal_sources,omitempty"`
	SignalWeight    float64  `protobuf:"fixed64,4,opt,name=signal_weight,json=signalWeight,proto3" json:"signal_weight,omitempty"`
	TechnicalWeight float64  `protobuf:"fixed64,5,opt,name=technical_weight,json=technicalWeight,proto3" json:"technical_weight,omitempty"`
	MinConviction   float64  `protobuf:"fixed64,6,opt,name=min_conviction,json=minConviction,proto3" json:"min_conviction,omitempty"`
	...
	EvaluationWindow *v1.TimeRange `protobuf:"bytes,8,opt,name=evaluation_window,json=evaluationWindow,proto3" json:"evaluation_window,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *ScreenSymbolsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ScreenSymbolsRequest) GetCriteria() []*ScreenCriterion {
	if x != nil {
		return x.Criteria
	}
	return nil
...
func (x *ScreenSymbolsRequest) GetSignalSources() []string {
	if x != nil {
		return x.SignalSources
	}
	return nil
}

func (x *ScreenSymbolsRequest) GetSignalWeight() float64 {
	if x != nil {
...
func (x *ScreenSymbolsRequest) GetTechnicalWeight() float64 {
	if x != nil {
		return x.TechnicalWeight
	}
	return 0
}

func (x *ScreenSymbolsRequest) GetMinConviction() float64 {
	if x != nil {
		return x.MinConviction
	}
	return 0
}

func (x *ScreenSymbolsRequest) GetRankLimit() int32 {
	if x != nil {
		return x.RankLimit
	}
	return 0
...
func (x *ScreenSymbolsRequest) GetEvaluationWindow() *v1.TimeRange {
	if x != nil {
...
type ScreenSymbolsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Results       []*ScreenResult        `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
	CoverageGaps  []*CoverageGap         `protobuf:"bytes,2,rep,name=coverage_gaps,json=coverageGaps,proto3" json:"coverage_gaps,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ScreenSymbolsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ScreenSymbolsResponse) GetCoverageGaps() []*CoverageGap {
	if x != nil {
		return x.CoverageGaps
	}
	return nil
...
type RunFundamentalsScanRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Force         bool                   `protobuf:"varint,1,opt,name=force,proto3" json:"force,omitempty"`                 // ignore the day's idempotency guard / re-emit
	DryRun        bool                   `protobuf:"varint,2,opt,name=dry_run,json=dryRun,proto3" json:"dry_run,omitempty"` // score + report but do not emit or spend cache calls
	Symbols       []string               `protobuf:"bytes,3,rep,name=symbols,proto3" json:"symbols,omitempty"`              // optional explicit override of the computed universe
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RunFundamentalsScanRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *RunFundamentalsScanRequest) GetDryRun() bool {
	if x != nil {
		return x.DryRun
	}
	return false
...
func (x *RunFundamentalsScanRequest) GetSymbols() []string {
	if x != nil {
		return x.Symbols
	}
	return nil
...
type FundamentalsScanSummary struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	RunId            string                 `protobuf:"bytes,1,opt,name=run_id,json=runId,proto3" json:"run_id,omitempty"`
	SymbolsProcessed int32                  `protobuf:"varint,2,opt,name=symbols_processed,json=symbolsProcessed,proto3" json:"symbols_processed,omitempty"`
	SignalsEmitted   int32                  `protobuf:"varint,3,opt,name=signals_emitted,json=signalsEmitted,proto3" json:"signals_emitted,omitempty"`
	CallsSpent       int32                  `protobuf:"varint,4,opt,name=calls_spent,json=callsSpent,proto3" json:"calls_spent,omitempty"`
	DeferredCount    int32                  `protobuf:"varint,5,opt,name=deferred_count,json=deferredCount,proto3" json:"deferred_count,omitempty"`
	Status           string                 `protobuf:"bytes,6,opt,name=status,proto3" json:"status,omitempty"` // "completed" | "budget_deferred" | "failed"
...
func (x *FundamentalsScanSummary) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *FundamentalsScanSummary) GetSymbolsProcessed() int32 {
	if x != nil {
		return x.SymbolsProcessed
	}
	return 0
}

func (x *FundamentalsScanSummary) GetSignalsEmitted() int32 {
	if x != nil {
...
func (x *FundamentalsScanSummary) GetCallsSpent() int32 {
	if x != nil {
		return x.CallsSpent
	}
	return 0
...
func (x *FundamentalsScanSummary) GetDeferredCount() int32 {
	if x != nil {
...
func (x *FundamentalsScanSummary) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *FundamentalsScanSummary) GetFinishedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.FinishedAt
	}
	return nil
...
type Opportunity struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Symbol            string                 `protobuf:"bytes,1,opt,name=symbol,proto3" json:"symbol,omitempty"`
	Action            OpportunityActionTag   `protobuf:"varint,2,opt,name=action,proto3,enum=xstockstrat.analysis.v1.OpportunityActionTag" json:"action,omitempty"`
	Conviction        float64                `protobuf:"fixed64,3,opt,name=conviction,proto3" json:"conviction,omitempty"`
	PassingConditions int32                  `protobuf:"varint,4,opt,name=passing_conditions,json=passingConditions,proto3" json:"passing_conditions,omitempty"`
	TotalConditions   int32                  `protobuf:"varint,5,opt,name=total_conditions,json=totalConditions,proto3" json:"total_conditions,omitempty"`
	Thesis            string                 `protobuf:"bytes,6,opt,name=thesis,proto3" json:"thesis,omitempty"`
...
func (x *Opportunity) GetAction() OpportunityActionTag {
	if x != nil {
		return x.Action
	}
	return OpportunityActionTag_OPPORTUNITY_ACTION_TAG_UNSPECIFIED
}

func (x *Opportunity) GetConviction() float64 {
	if x != nil {
		return x.Conviction
	}
	return 0
...
func (x *Opportunity) GetPassingConditions() int32 {
	if x != nil {
		return x.PassingConditions
	}
	return 0
}

func (x *Opportunity) GetTotalConditions() int32 {
	if x != nil {
...
func (x *Opportunity) GetThesis() string {
	if x != nil {
		return x.Thesis
	}
	return ""
...
func (x *Opportunity) GetStrategyId() string {
	if x != nil {
		return x.StrategyId
	}
	return ""
...
func (x *Opportunity) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
func (x *Opportunity) GetValidUntil() *timestamppb.Timestamp {
	if x != nil {
		return x.ValidUntil
	}
	return nil
...
func (x *Opportunity) GetOpportunityKey() string {
	if x != nil {
		return x.OpportunityKey
	}
	return ""
}

func (x *Opportunity) GetProvenance() []string {
	if x != nil {
		return x.Provenance
	}
	return nil
...
func (x *Opportunity) GetLivePrice() float64 {
	if x != nil && x.LivePrice != nil {
		return *x.LivePrice
	}
	return 0
}

func (x *Opportunity) GetChangePct() float64 {
...
func (x *Opportunity) GetTargetPrice() float64 {
...
func (x *Opportunity) GetStopPrice() float64 {
...
func (x *Opportunity) GetSparkline() []*SparklinePoint {
	if x != nil {
		return x.Sparkline
	}
	return nil
...
func (x *Opportunity) GetConditions() []*ConditionEval {
	if x != nil {
		return x.Conditions
	}
	return nil
...
type SparklinePoint struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Close         *float64               `protobuf:"fixed64,1,opt,name=close,proto3,oneof" json:"close,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ConditionEval struct {
	state               protoimpl.MessageState `protogen:"open.v1"`
	RefName             string                 `protobuf:"bytes,1,opt,name=ref_name,json=refName,proto3" json:"ref_name,omitempty"`
	LhsValue            float64                `protobuf:"fixed64,2,opt,name=lhs_value,json=lhsValue,proto3" json:"lhs_value,omitempty"`
	Threshold           float64                `protobuf:"fixed64,3,opt,name=threshold,proto3" json:"threshold,omitempty"`
	Fn                  string                 `protobuf:"bytes,4,opt,name=fn,proto3" json:"fn,omitempty"` // >, <, >=, <=, crosses_above, crosses_below
	State               ConditionState         `protobuf:"varint,5,opt,name=state,proto3,enum=xstockstrat.analysis.v1.ConditionState" json:"state,omitempty"`
	DistanceToThreshold float64                `protobuf:"fixed64,6,opt,name=distance_to_threshold,json=distanceToThreshold,proto3" json:"distance_to_threshold,omitempty"` // normalized
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ConditionEval) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ConditionEval) GetLhsValue() float64 {
	if x != nil {
		return x.LhsValue
	}
	return 0
...
func (x *ConditionEval) GetThreshold() float64 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
func (x *ConditionEval) GetFn() string {
	if x != nil {
		return x.Fn
	}
	return ""
...
func (x *ConditionEval) GetState() ConditionState {
	if x != nil {
		return x.State
	}
...
func (x *ConditionEval) GetDistanceToThreshold() float64 {
	if x != nil {
		return x.DistanceToThreshold
	}
	return 0
}
...
type SymbolReadiness struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	Symbol            string                 `protobuf:"bytes,1,opt,name=symbol,proto3" json:"symbol,omitempty"`
	Conviction        float64                `protobuf:"fixed64,2,opt,name=conviction,proto3" json:"conviction,omitempty"`
	PassingConditions int32                  `protobuf:"varint,3,opt,name=passing_conditions,json=passingConditions,proto3" json:"passing_conditions,omitempty"`
	TotalConditions   int32                  `protobuf:"varint,4,opt,name=total_conditions,json=totalConditions,proto3" json:"total_conditions,omitempty"`
	Conditions        []*ConditionEval       `protobuf:"bytes,5,rep,name=conditions,proto3" json:"conditions,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *SymbolReadiness) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SymbolReadiness) GetConviction() float64 {
	if x != nil {
		return x.Conviction
	}
	return 0
...
func (x *SymbolReadiness) GetPassingConditions() int32 {
	if x != nil {
		return x.PassingConditions
	}
	return 0
...
func (x *SymbolReadiness) GetTotalConditions() int32 {
	if x != nil {
		return x.TotalConditions
	}
	return 0
...
func (x *SymbolReadiness) GetConditions() []*ConditionEval {
	if x != nil {
		return x.Conditions
	}
	return nil
...
type StrategyAnalytics struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	StrategyId     string                 `protobuf:"bytes,1,opt,name=strategy_id,json=strategyId,proto3" json:"strategy_id,omitempty"`
	Expectancy     float64                `protobuf:"fixed64,2,opt,name=expectancy,proto3" json:"expectancy,omitempty"`
	BlendedHitRate float64                `protobuf:"fixed64,3,opt,name=blended_hit_rate,json=blendedHitRate,proto3" json:"blended_hit_rate,omitempty"`
	MaxDrawdown    float64                `protobuf:"fixed64,4,opt,name=max_drawdown,json=maxDrawdown,proto3" json:"max_drawdown,omitempty"`
	Signals_30D    int32                  `protobuf:"varint,5,opt,name=signals_30d,json=signals30d,proto3" json:"signals_30d,omitempty"`
	Taken          int32                  `protobuf:"varint,6,opt,name=taken,proto3" json:"taken,omitempty"`
	QueueShare     float64                `protobuf:"fixed64,7,opt,name=queue_share,json=queueShare,proto3" json:"queue_share,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *StrategyAnalytics) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *StrategyAnalytics) GetExpectancy() float64 {
	if x != nil {
		return x.Expectancy
	}
	return 0
...
func (x *StrategyAnalytics) GetBlendedHitRate() float64 {
	if x != nil {
		return x.BlendedHitRate
	}
	return 0
}

func (x *StrategyAnalytics) GetMaxDrawdown() float64 {
	if x != nil {
		return x.MaxDrawdown
	}
	return 0
...
func (x *StrategyAnalytics) GetSignals_30D() int32 {
	if x != nil {
		return x.Signals_30D
	}
	return 0
}

func (x *StrategyAnalytics) GetTaken() int32 {
	if x != nil {
		return x.Taken
	}
	return 0
...
func (x *StrategyAnalytics) GetQueueShare() float64 {
	if x != nil {
		return x.QueueShare
	}
	return 0
...
type ListOpportunitiesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Page          *v1.PageRequest        `protobuf:"bytes,1,opt,name=page,proto3" json:"page,omitempty"`
	MinConviction float64                `protobuf:"fixed64,2,opt,name=min_conviction,json=minConviction,proto3" json:"min_conviction,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListOpportunitiesRequest) GetMinConviction() float64 {
	if x != nil {
		return x.MinConviction
	}
	return 0
...
func (x *ListOpportunitiesResponse) GetPage() *v1.PageResponse {
	if x != nil {
		return x.Page
	}
	return nil
...
type EvaluateReadinessRequest struct {
	...
	Rule          ReadinessRule `protobuf:"varint,3,opt,name=rule,proto3,enum=xstockstrat.analysis.v1.ReadinessRule" json:"rule,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EvaluateReadinessRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *EvaluateReadinessRequest) GetSymbols() []string {
	if x != nil {
		return x.Symbols
	}
	return nil
...
func (x *EvaluateReadinessRequest) GetRule() ReadinessRule {
	if x != nil {
		return x.Rule
	}
	return ReadinessRule_READINESS_RULE_UNSPECIFIED
}

type EvaluateReadinessResponse struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	Readiness []*SymbolReadiness     `protobuf:"bytes,1,rep,name=readiness,proto3" json:"readiness,omitempty"`
...
func (x *EvaluateReadinessResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *EvaluateReadinessResponse) GetComputedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ComputedAt
	}
	return nil
...
type WatchlistReadinessRow struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Symbol        string                 `protobuf:"bytes,1,opt,name=symbol,proto3" json:"symbol,omitempty"`
	StrategyId    string                 `protobuf:"bytes,2,opt,name=strategy_id,json=strategyId,proto3" json:"strategy_id,omitempty"`
	State         ReadinessState         `protobuf:"varint,3,opt,name=state,proto3,enum=xstockstrat.analysis.v1.ReadinessState" json:"state,omitempty"`
	Readiness     *SymbolReadiness       `protobuf:"bytes,4,opt,name=readiness,proto3" json:"readiness,omitempty"`
...
func (x *WatchlistReadinessRow) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *WatchlistReadinessRow) GetStrategyId() string {
	if x != nil {
		return x.StrategyId
	}
	return ""
...
func (x *WatchlistReadinessRow) GetState() ReadinessState {
	if x != nil {
		return x.State
	}
...
func (x *WatchlistReadinessRow) GetReadiness() *SymbolReadiness {
	if x != nil {
		return x.Readiness
	}
	return nil
...
func (x *WatchlistReadinessRow) GetComputedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ComputedAt
	}
	return nil
...
type GetWatchlistReadinessRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetWatchlistReadinessRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetWatchlistReadinessRequest) GetPage() *v1.PageRequest {
	if x != nil {
		return x.Page
	}
	return nil
...
type GetWatchlistReadinessResponse struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	Rows          []*WatchlistReadinessRow `protobuf:"bytes,1,rep,name=rows,proto3" json:"rows,omitempty"`
	Page          *v1.PageResponse         `protobuf:"bytes,2,opt,name=page,proto3" json:"page,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetWatchlistReadinessResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetWatchlistReadinessResponse) GetPage() *v1.PageResponse {
	if x != nil {
		return x.Page
	}
	return nil
...
type SetOpportunityActionRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	OpportunityKey string                 `protobuf:"bytes,1,opt,name=opportunity_key,json=opportunityKey,proto3" json:"opportunity_key,omitempty"` // the server-issued key, echoed verbatim
	Action         OpportunityAction      `protobuf:"varint,2,opt,name=action,proto3,enum=xstockstrat.analysis.v1.OpportunityAction" json:"action,omitempty"`
	SnoozeUntil    *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=snooze_until,json=snoozeUntil,proto3" json:"snooze_until,omitempty"` // set only for SNOOZE; a bounded "snooze until"
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SetOpportunityActionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *SetOpportunityActionRequest) GetAction() OpportunityAction {
	if x != nil {
		return x.Action
	}
	return OpportunityAction_OPPORTUNITY_ACTION_UNSPECIFIED
}

func (x *SetOpportunityActionRequest) GetSnoozeUntil() *timestamppb.Timestamp {
	if x != nil {
...
type SetOpportunityActionResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SetOpportunityActionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetStrategyAnalyticsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type GetIndicatorSeriesRequest struct {
	state      protoimpl.MessageState `protogen:"open.v1"`
	StrategyId string                 `protobuf:"bytes,1,opt,name=strategy_id,json=strategyId,proto3" json:"strategy_id,omitempty"`
	...
	Closes        []float64                `protobuf:"fixed64,3,rep,packed,name=closes,proto3" json:"closes,omitempty"`
...
func (x *GetIndicatorSeriesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetIndicatorSeriesRequest) GetSymbol() string {
	if x != nil {
		return x.Symbol
	}
	return ""
...
func (x *GetIndicatorSeriesRequest) GetCloses() []float64 {
	if x != nil {
		return x.Closes
	}
	return nil
...
func (x *GetIndicatorSeriesRequest) GetTimes() []*timestamppb.Timestamp {
	if x != nil {
		return x.Times
	}
	return nil
...
type GetIndicatorSeriesResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	Components    []*ComponentSeries       `protobuf:"bytes,2,rep,name=components,proto3" json:"components,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetIndicatorSeriesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetIndicatorSeriesResponse) GetComponents() []*ComponentSeries {
	if x != nil {
		return x.Components
	}
	return nil
...
type ComponentSeries struct {
	...
	RefName string                 `protobuf:"bytes,1,opt,name=ref_name,json=refName,proto3" json:"ref_name,omitempty"`
	Kind    ComponentKind          `protobuf:"varint,2,opt,name=kind,proto3,enum=xstockstrat.analysis.v1.ComponentKind" json:"kind,omitempty"`
	Series  []*NamedSeries         `protobuf:"bytes,3,rep,name=series,proto3" json:"series,omitempty"`
...
func (x *ComponentSeries) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ComponentSeries) GetKind() ComponentKind {
	if x != nil {
		return x.Kind
	}
	return ComponentKind_COMPONENT_KIND_UNSPECIFIED
...
func (x *ComponentSeries) GetSeries() []*NamedSeries {
	if x != nil {
		return x.Series
	}
	return nil
...
func (x *ComponentSeries) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
type NamedSeries struct {
	...
	Values        []*IndicatorValue `protobuf:"bytes,2,rep,name=values,proto3" json:"values,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *NamedSeries) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *NamedSeries) GetValues() []*IndicatorValue {
	if x != nil {
		return x.Values
	}
	return nil
...
type GetAttributionRequest struct {
	...
	SourceId      string                 `protobuf:"bytes,3,opt,name=source_id,json=sourceId,proto3" json:"source_id,omitempty"` // optional filter — the signal_sources.slug; empty = all sources (open registry, C-04: string not enum)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetAttributionRequest) GetEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
...
func (x *GetAttributionRequest) GetSourceId() string {
	if x != nil {
		return x.SourceId
	}
	return ""
...
type SourceAttribution struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SourceId      string                 `protobuf:"bytes,1,opt,name=source_id,json=sourceId,proto3" json:"source_id,omitempty"`       // signal_sources.slug (the snapshot's signal source)
	SourceName    string                 `protobuf:"bytes,2,opt,name=source_name,json=sourceName,proto3" json:"source_name,omitempty"` // resolved via ingest ListSignalSources; falls back to the slug
	TradeCount    float64                `protobuf:"fixed64,3,opt,name=trade_count,json=tradeCount,proto3" json:"trade_count,omitempty"`
	WinCount      float64                `protobuf:"fixed64,4,opt,name=win_count,json=winCount,proto3" json:"win_count,omitempty"`
	WinRate       float64                `protobuf:"fixed64,5,opt,name=win_rate,json=winRate,proto3" json:"win_rate,omitempty"`       // win_count / trade_count
	AvgReturn     float64                `protobuf:"fixed64,6,opt,name=avg_return,json=avgReturn,proto3" json:"avg_return,omitempty"` // mean per-trade net_pnl / cost_basis (percent, v1 approximation)
	TotalPnl      float64                `protobuf:"fixed64,7,opt,name=total_pnl,json=totalPnl,proto3" json:"total_pnl,omitempty"`    // net of fees
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SourceAttribution) GetSourceName() string {
	if x != nil {
		return x.SourceName
	}
	return ""
...
func (x *SourceAttribution) GetTradeCount() float64 {
	if x != nil {
		return x.TradeCount
	}
	return 0
...
func (x *SourceAttribution) GetWinCount() float64 {
	if x != nil {
		return x.WinCount
	}
	return 0
...
func (x *SourceAttribution) GetWinRate() float64 {
	if x != nil {
		return x.WinRate
	}
	return 0
...
func (x *SourceAttribution) GetAvgReturn() float64 {
	if x != nil {
		return x.AvgReturn
	}
	return 0
...
func (x *SourceAttribution) GetTotalPnl() float64 {
	if x != nil {
		return x.TotalPnl
	}
	return 0
...
type GetAttributionResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Attributions  []*SourceAttribution   `protobuf:"bytes,1,rep,name=attributions,proto3" json:"attributions,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_analysis_v1_analysis_proto_rawDesc = "" +
	"\n" +
	"\x1aanalysis/v1/analysis.proto\x12\x17xstockstrat.analysis.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a google/protobuf/field_mask.proto\x1a\x16common/v1/common.proto\"\xfd\x03\n" +
	...
	"\x11inline_definition\x18\a \x01(\v2+.xstockstrat.analysis.v1.StrategyDefinitionR\x10inlineDefinition\x12D\n" +
	"\vsizing_mode\x18\b \x01(\x0e2#.xstockstrat.analysis.v1.SizingModeR\n" +
	"sizingMode\x12A\n" +
	"\n" +
	"fill_model\x18\t \x01(\x0e2\".xstockstrat.analysis.v1.FillModelR\tfillModel\"\x9e\x02\n" +
	...
	"\x03gap\x18\x06 \x01(\v2 .xstockstrat.common.v1.TimeRangeR\x03gap\"\xa0\b\n" +
	...
	"\bwarnings\x18\x10 \x03(\tR\bwarnings\x12D\n" +
	"\vsizing_mode\x18\x11 \x01(\x0e2#.xstockstrat.analysis.v1.SizingModeR\n" +
	"sizingMode\x12R\n" +
	"\rcapital_skips\x18\x12 \x03(\v2-.xstockstrat.analysis.v1.PortfolioCapitalSkipR\fcapitalSkips\x12Z\n" +
	"\x16portfolio_equity_curve\x18\x13 \x03(\v2$.xstockstrat.analysis.v1.EquityPointR\x14portfolioEquityCurve\x12A\n" +
	"\n" +
	"fill_model\x18\x14 \x01(\x0e2\".xstockstrat.analysis.v1.FillModelR\tfillModel\"\xb8\x01\n" +
	"\x14PortfolioCapitalSkip\x12\x16\n" +
	"\x06symbol\x18\x01 \x01(\tR\x06symbol\x128\n" +
	"\ttimestamp\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12'\n" +
	"\x0fintended_weight\x18\x03 \x01(\x01R\x0eintendedWeight\x12%\n" +
	"\x0eavailable_cash\x18\x04 \x01(\x01R\ravailableCash\"_\n" +
	"\vEquityPoint\x128\n" +
	"\ttimestamp\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12\x16\n" +
	"\x06equity\x18\x02 \x01(\x01R\x06equity\"\x91\x02\n" +
	...
	"\texit_time\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\bexitTime\"\xc0\x04\n" +
	"\rBarDiagnostic\x12\x16\n" +
	"\x06symbol\x18\x01 \x01(\tR\x06symbol\x12\x1b\n" +
	"\tbar_index\x18\x02 \x01(\x05R\bbarIndex\x128\n" +
	...
	"\x04vwap\x18\t \x01(\x01R\x04vwap\x12V\n" +
	"\n" +
	"indicators\x18\n" +
	" \x03(\v26.xstockstrat.analysis.v1.BarDiagnostic.IndicatorsEntryR\n" +
	"indicators\x12\x16\n" +
	"\x06warmup\x18\v \x01(\bR\x06warmup\x12!\n" +
	"\fsignal_score\x18\f \x01(\x01R\vsignalScore\x12\x1e\n" +
	"\n" +
	"conviction\x18\r \x01(\x01R\n" +
	"conviction\x12:\n" +
	"\x06action\x18\x0e \x01(\x0e2\".xstockstrat.analysis.v1.BarActionR\x06action\x12\x16\n" +
	"\x06equity\x18\x0f \x01(\x01R\x06equity\x1a=\n" +
	"\x0fIndicatorsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\"\xf7\x01\n" +
	"\x11SymbolDiagnostics\x12\x16\n" +
	"\x06symbol\x18\x01 \x01(\tR\x06symbol\x12:\n" +
	"\x04bars\x18\x02 \x03(\v2&.xstockstrat.analysis.v1.BarDiagnosticR\x04bars\x12N\n" +
	"\x0fno_trade_reason\x18\x03 \x01(\x0e2&.xstockstrat.analysis.v1.NoTradeReasonR\rnoTradeReason\x12\x1d\n" +
	"\n" +
	"bars_total\x18\x04 \x01(\x05R\tbarsTotal\x12\x1f\n" +
	"\vwarmup_bars\x18\x05 \x01(\x05R\n" +
	"warmupBars\"o\n" +
	...
	"\bmetadata\x18\x04 \x01(\v2\x17.google.protobuf.StructR\bmetadata\"M\n" +
	"\x14ListBacktestsRequest\x12\x1f\n" +
	"\vstrategy_id\x18\x01 \x01(\tR\n" +
	"strategyId\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x05R\x05limit\"\xa5\x06\n" +
	"\x12BacktestRunSummary\x12\x1f\n" +
	"\vbacktest_id\x18\x01 \x01(\tR\n" +
	"backtestId\x12\x1f\n" +
	"\vstrategy_id\x18\x02 \x01(\tR\n" +
	"strategyId\x12?\n" +
	"\x06status\x18\x03 \x01(\x0e2'.xstockstrat.analysis.v1.BacktestStatusR\x06status\x12!\n" +
	"\ftotal_return\x18\x04 \x01(\x01R\vtotalReturn\x12+\n" +
	"\x11annualized_return\x18\x05 \x01(\x01R\x10annualizedReturn\x12!\n" +
	"\fsharpe_ratio\x18\x06 \x01(\x01R\vsharpeRatio\x12!\n" +
	"\fmax_drawdown\x18\a \x01(\x01R\vmaxDrawdown\x12\x19\n" +
	"\bwin_rate\x18\b \x01(\x01R\awinRate\x12!\n" +
	"\ftotal_trades\x18\t \x01(\x05R\vtotalTrades\x12#\n" +
	"\rprofit_factor\x18\n" +
	" \x01(\x01R\fprofitFactor\x12\x18\n" +
	"\asymbols\x18\v \x03(\tR\asymbols\x12#\n" +
	"\roverall_score\x18\f \x01(\x01R\foverallScore\x12\x16\n" +
	...
	"rangeStart\x127\n" +
	"\trange_end\x18\x10 \x01(\v2\x1a.google.protobuf.TimestampR\brangeEnd\x12D\n" +
	"\vsizing_mode\x18\x11 \x01(\x0e2#.xstockstrat.analysis.v1.SizingModeR\n" +
	"sizingMode\x12A\n" +
	"\n" +
	"fill_model\x18\x12 \x01(\x0e2\".xstockstrat.analysis.v1.FillModelR\tfillModel\"X\n" +
	...
	"definition\"\x83\x03\n" +
	"\x0fScreenCriterion\x12\x19\n" +
	"\bref_name\x18\x01 \x01(\tR\arefName\x127\n" +
	"\x04kind\x18\x02 \x01(\x0e2#.xstockstrat.analysis.v1.ScreenKindR\x04kind\x12\x1f\n" +
	"\vmetric_name\x18\x03 \x01(\tR\n" +
	"metricName\x12H\n" +
	"\tcomponent\x18\x04 \x01(\v2*.xstockstrat.analysis.v1.StrategyComponentR\tcomponent\x123\n" +
	"\x02op\x18\x05 \x01(\x0e2#.xstockstrat.analysis.v1.ComparatorR\x02op\x12\x1c\n" +
	...
	"\x10criterion_scores\x18\x03 \x03(\v2:.xstockstrat.analysis.v1.ScreenResult.CriterionScoresEntryR\x0fcriterionScores\x12\x16\n" +
	"\x06passed\x18\x04 \x01(\bR\x06passed\x12C\n" +
	"\x06status\x18\x05 \x01(\x0e2+.xstockstrat.analysis.v1.ScreenResultStatusR\x06status\x126\n" +
	"\x03gap\x18\x06 \x01(\v2$.xstockstrat.analysis.v1.CoverageGapR\x03gap\x12\x0e\n" +
	"\x02pe\x18\a \x01(\x01R\x02pe\x12\x10\n" +
	"\x03rsi\x18\b \x01(\x01R\x03rsi\x12\x10\n" +
	"\x03atr\x18\t \x01(\x01R\x03atr\x12\x1d\n" +
	"\n" +
	"rev_growth\x18\n" +
	...
	"\x17CriterionRawValuesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x01R\x05value:\x028\x01\x1aB\n" +
	"\x14CriterionPassedEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\bR\x05value:\x028\x01\"\x82\x03\n" +
	"\x14ScreenSymbolsRequest\x12\x18\n" +
	"\asymbols\x18\x01 \x03(\tR\asymbols\x12D\n" +
	"\bcriteria\x18\x02 \x03(\v2(.xstockstrat.analysis.v1.ScreenCriterionR\bcriteria\x12%\n" +
	"\x0esignal_sources\x18\x03 \x03(\tR\rsignalSources\x12#\n" +
	"\rsignal_weight\x18\x04 \x01(\x01R\fsignalWeight\x12)\n" +
	"\x10technical_weight\x18\x05 \x01(\x01R\x0ftechnicalWeight\x12%\n" +
	"\x0emin_conviction\x18\x06 \x01(\x01R\rminConviction\x12\x1d\n" +
	"\n" +
	"rank_limit\x18\a \x01(\x05R\trankLimit\x12M\n" +
	"\x11evaluation_window\x18\b \x01(\v2 .xstockstrat.common.v1.TimeRangeR\x10evaluationWindow\"\xa3\x01\n" +
	"\x15ScreenSymbolsResponse\x12?\n" +
	"\aresults\x18\x01 \x03(\v2%.xstockstrat.analysis.v1.ScreenResultR\aresults\x12I\n" +
	"\rcoverage_gaps\x18\x02 \x03(\v2$.xstockstrat.analysis.v1.CoverageGapR\fcoverageGaps\"e\n" +
	"\x1aRunFundamentalsScanRequest\x12\x14\n" +
	"\x05force\x18\x01 \x01(\bR\x05force\x12\x17\n" +
	"\adry_run\x18\x02 \x01(\bR\x06dryRun\x12\x18\n" +
	"\asymbols\x18\x03 \x03(\tR\asymbols\"\xa3\x02\n" +
	"\x17FundamentalsScanSummary\x12\x15\n" +
	"\x06run_id\x18\x01 \x01(\tR\x05runId\x12+\n" +
	"\x11symbols_processed\x18\x02 \x01(\x05R\x10symbolsProcessed\x12'\n" +
	"\x0fsignals_emitted\x18\x03 \x01(\x05R\x0esignalsEmitted\x12\x1f\n" +
	"\vcalls_spent\x18\x04 \x01(\x05R\n" +
	"callsSpent\x12%\n" +
	...
	"\n" +
	"conviction\x18\x03 \x01(\x01R\n" +
	"conviction\x12-\n" +
	"\x12passing_conditions\x18\x04 \x01(\x05R\x11passingConditions\x12)\n" +
	"\x10total_conditions\x18\x05 \x01(\x05R\x0ftotalConditions\x12\x16\n" +
	"\x06thesis\x18\x06 \x01(\tR\x06thesis\x12\x1f\n" +
	"\vstrategy_id\x18\a \x01(\tR\n" +
	"strategyId\x12\x16\n" +
	"\x06source\x18\b \x01(\tR\x06source\x12;\n" +
	"\vvalid_until\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"validUntil\x12'\n" +
	"\x0fopportunity_key\x18\n" +
	" \x01(\tR\x0eopportunityKey\x12\x1e\n" +
	"\n" +
	"provenance\x18\v \x03(\tR\n" +
	"provenance\x12\x14\n" +
	"\x05muted\x18\f \x01(\bR\x05muted\x12\"\n" +
	"\n" +
	"live_price\x18\r \x01(\x01H\x00R\tlivePrice\x88\x01\x01\x12\"\n" +
	"\n" +
	"change_pct\x18\x0e \x01(\x01H\x01R\tchangePct\x88\x01\x01\x12&\n" +
	"\ftarget_price\x18\x0f \x01(\x01H\x02R\vtargetPrice\x88\x01\x01\x12\"\n" +
	"\n" +
	"stop_price\x18\x10 \x01(\x01H\x03R\tstopPrice\x88\x01\x01\x12E\n" +
	...
	"\tthreshold\x18\x03 \x01(\x01R\tthreshold\x12\x0e\n" +
	"\x02fn\x18\x04 \x01(\tR\x02fn\x12=\n" +
	"\x05state\x18\x05 \x01(\x0e2'.xstockstrat.analysis.v1.ConditionStateR\x05state\x122\n" +
	"\x15distance_to_threshold\x18\x06 \x01(\x01R\x13distanceToThreshold\"\xeb\x01\n" +
	"\x0fSymbolReadiness\x12\x16\n" +
	"\x06symbol\x18\x01 \x01(\tR\x06symbol\x12\x1e\n" +
	"\n" +
	"conviction\x18\x02 \x01(\x01R\n" +
	"conviction\x12-\n" +
	"\x12passing_conditions\x18\x03 \x01(\x05R\x11passingConditions\x12)\n" +
	"\x10total_conditions\x18\x04 \x01(\x05R\x0ftotalConditions\x12F\n" +
	"\n" +
	"conditions\x18\x05 \x03(\v2&.xstockstrat.analysis.v1.ConditionEvalR\n" +
	"conditions\"\xf9\x01\n" +
	"\x11StrategyAnalytics\x12\x1f\n" +
	"\vstrategy_id\x18\x01 \x01(\tR\n" +
	"strategyId\x12\x1e\n" +
	"\n" +
	"expectancy\x18\x02 \x01(\x01R\n" +
	"expectancy\x12(\n" +
	"\x10blended_hit_rate\x18\x03 \x01(\x01R\x0eblendedHitRate\x12!\n" +
	"\fmax_drawdown\x18\x04 \x01(\x01R\vmaxDrawdown\x12\x1f\n" +
	"\vsignals_30d\x18\x05 \x01(\x05R\n" +
	"signals30d\x12\x14\n" +
	"\x05taken\x18\x06 \x01(\x05R\x05taken\x12\x1f\n" +
	"\vqueue_share\x18\a \x01(\x01R\n" +
	"queueShare\"y\n" +
	...
	"\x04rule\x18\x03 \x01(\x0e2&.xstockstrat.analysis.v1.ReadinessRuleR\x04rule\"\xa0\x01\n" +
	"\x19EvaluateReadinessResponse\x12F\n" +
	"\treadiness\x18\x01 \x03(\v2(.xstockstrat.analysis.v1.SymbolReadinessR\treadiness\x12;\n" +
	"\vcomputed_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"computedAt\"\x94\x02\n" +
	"\x15WatchlistReadinessRow\x12\x16\n" +
	"\x06symbol\x18\x01 \x01(\tR\x06symbol\x12\x1f\n" +
	"\vstrategy_id\x18\x02 \x01(\tR\n" +
	"strategyId\x12=\n" +
	"\x05state\x18\x03 \x01(\x0e2'.xstockstrat.analysis.v1.ReadinessStateR\x05state\x12F\n" +
	"\treadiness\x18\x04 \x01(\v2(.xstockstrat.analysis.v1.SymbolReadinessR\treadiness\x12;\n" +
	"\vcomputed_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"computedAt\"y\n" +
	"\x1cGetWatchlistReadinessRequest\x12!\n" +
	"\fwatchlist_id\x18\x01 \x01(\tR\vwatchlistId\x126\n" +
	"\x04page\x18\x02 \x01(\v2\".xstockstrat.common.v1.PageRequestR\x04page\"\x9c\x01\n" +
	"\x1dGetWatchlistReadinessResponse\x12B\n" +
	"\x04rows\x18\x01 \x03(\v2..xstockstrat.analysis.v1.WatchlistReadinessRowR\x04rows\x127\n" +
	"\x04page\x18\x02 \x01(\v2#.xstockstrat.common.v1.PageResponseR\x04page\"\xc9\x01\n" +
	"\x1bSetOpportunityActionRequest\x12'\n" +
	"\x0fopportunity_key\x18\x01 \x01(\tR\x0eopportunityKey\x12B\n" +
	"\x06action\x18\x02 \x01(\x0e2*.xstockstrat.analysis.v1.OpportunityActionR\x06action\x12=\n" +
	"\fsnooze_until\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\vsnoozeUntil\"\x1e\n" +
	"\x1cSetOpportunityActionResponse\">\n" +
	"\x1bGetStrategyAnalyticsRequest\x12\x1f\n" +
	"\vstrategy_id\x18\x01 \x01(\tR\n" +
	"strategyId\"\x9e\x01\n" +
	"\x19GetIndicatorSeriesRequest\x12\x1f\n" +
	"\vstrategy_id\x18\x01 \x01(\tR\n" +
	"strategyId\x12\x16\n" +
	"\x06symbol\x18\x02 \x01(\tR\x06symbol\x12\x16\n" +
	"\x06closes\x18\x03 \x03(\x01R\x06closes\x120\n" +
	"\x05times\x18\x04 \x03(\v2\x1a.google.protobuf.TimestampR\x05times\"\x98\x01\n" +
	"\x1aGetIndicatorSeriesResponse\x120\n" +
	"\x05times\x18\x01 \x03(\v2\x1a.google.protobuf.TimestampR\x05times\x12H\n" +
	"\n" +
	"components\x18\x02 \x03(\v2(.xstockstrat.analysis.v1.ComponentSeriesR\n" +
	"components\"\xbc\x01\n" +
	"\x0fComponentSeries\x12\x19\n" +
	"\bref_name\x18\x01 \x01(\tR\arefName\x12:\n" +
	"\x04kind\x18\x02 \x01(\x0e2&.xstockstrat.analysis.v1.ComponentKindR\x04kind\x12<\n" +
	"\x06series\x18\x03 \x03(\v2$.xstockstrat.analysis.v1.NamedSeriesR\x06series\x12\x14\n" +
	"\x05error\x18\x04 \x01(\tR\x05error\"b\n" +
	"\vNamedSeries\x12\x12\n" +
	...
	"\x10negative_factors\x18\x02 \x03(\v2).xstockstrat.analysis.v1.PnLPatternFactorR\x0fnegativeFactors\"\x94\x01\n" +
	"\x15GetAttributionRequest\x120\n" +
	"\x05start\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x05start\x12,\n" +
	"\x03end\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x03end\x12\x1b\n" +
	"\tsource_id\x18\x03 \x01(\tR\bsourceId\"\xe6\x01\n" +
	"\x11SourceAttribution\x12\x1b\n" +
	"\tsource_id\x18\x01 \x01(\tR\bsourceId\x12\x1f\n" +
	"\vsource_name\x18\x02 \x01(\tR\n" +
	"sourceName\x12\x1f\n" +
	"\vtrade_count\x18\x03 \x01(\x01R\n" +
	"tradeCount\x12\x1b\n" +
	"\twin_count\x18\x04 \x01(\x01R\bwinCount\x12\x19\n" +
	"\bwin_rate\x18\x05 \x01(\x01R\awinRate\x12\x1d\n" +
	"\n" +
	...
	"!BACKTEST_STATUS_INSUFFICIENT_DATA\x10\x02*\\\n" +
	"\n" +
	"SizingMode\x12\x1b\n" +
	"\x17SIZING_MODE_UNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12SIZING_MODE_LEGACY\x10\x01\x12\x19\n" +
	"\x15SIZING_MODE_PORTFOLIO\x10\x02*d\n" +
	"\tFillModel\x12\x1a\n" +
	"\x16FILL_MODEL_UNSPECIFIED\x10\x00\x12\x1d\n" +
	"\x19FILL_MODEL_SAME_BAR_CLOSE\x10\x01\x12\x1c\n" +
	"\x18FILL_MODEL_NEXT_BAR_OPEN\x10\x02*\xa7\x01\n" +
	"\tBarAction\x12\x1a\n" +
	"\x16BAR_ACTION_UNSPECIFIED\x10\x00\x12\x15\n" +
	"\x11BAR_ACTION_WARMUP\x10\x01\x12\x18\n" +
	...
	"\x0eCOMPARATOR_LTE\x10\x02\x12\x11\n" +
	"\rCOMPARATOR_GT\x10\x03\x12\x12\n" +
	"\x0eCOMPARATOR_GTE\x10\x04\x12\x16\n" +
	"\x12COMPARATOR_BETWEEN\x10\x05*\xa6\x01\n" +
	"\n" +
	"ScreenKind\x12\x1b\n" +
	...
	"&SCREEN_RESULT_STATUS_INSUFFICIENT_DATA\x10\x02*\xa3\x01\n" +
	"\x14OpportunityActionTag\x12&\n" +
	...
	"\x1dOPPORTUNITY_ACTION_TAG_REDUCE\x10\x03*\x7f\n" +
	"\x0eConditionState\x12\x1f\n" +
	"\x1bCONDITION_STATE_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14CONDITION_STATE_PASS\x10\x01\x12\x18\n" +
	"\x14CONDITION_STATE_SOFT\x10\x02\x12\x18\n" +
	"\x14CONDITION_STATE_FAIL\x10\x03*b\n" +
	"\rReadinessRule\x12\x1e\n" +
	"\x1aREADINESS_RULE_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14READINESS_RULE_ENTRY\x10\x01\x12\x17\n" +
	"\x13READINESS_RULE_EXIT\x10\x02*\x89\x01\n" +
	"\x0eReadinessState\x12\x1f\n" +
	"\x1bREADINESS_STATE_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18READINESS_STATE_RESOLVED\x10\x01\x12\x1b\n" +
	"\x17READINESS_STATE_PENDING\x10\x02\x12\x1b\n" +
	"\x17READINESS_STATE_UNKNOWN\x10\x03*\x93\x01\n" +
	...
	"\x11GetStrategyReport\x121.xstockstrat.analysis.v1.GetStrategyReportRequest\x1a'.xstockstrat.analysis.v1.StrategyReport\x12n\n" +
	"\rListBacktests\x12-.xstockstrat.analysis.v1.ListBacktestsRequest\x1a..xstockstrat.analysis.v1.ListBacktestsResponse\x12c\n" +
	"\vGetBacktest\x12+.xstockstrat.analysis.v1.GetBacktestRequest\x1a'.xstockstrat.analysis.v1.BacktestResult\x12m\n" +
	...
	"\x0fSetStrategyLive\x12/.xstockstrat.analysis.v1.SetStrategyLiveRequest\x1a0.xstockstrat.analysis.v1.SetStrategyLiveResponse\x12n\n" +
	"\rScreenSymbols\x12-.xstockstrat.analysis.v1.ScreenSymbolsRequest\x1a..xstockstrat.analysis.v1.ScreenSymbolsResponse\x12|\n" +
	"\x13RunFundamentalsScan\x123.xstockstrat.analysis.v1.RunFundamentalsScanRequest\x1a0.xstockstrat.analysis.v1.FundamentalsScanSummary\x12z\n" +
	"\x11ListOpportunities\x121.xstockstrat.analysis.v1.ListOpportunitiesRequest\x1a2.xstockstrat.analysis.v1.ListOpportunitiesResponse\x12z\n" +
...
var file_analysis_v1_analysis_proto_enumTypes = make([]protoimpl.EnumInfo, 17)
...
var file_analysis_v1_analysis_proto_goTypes = []any{
	...
	(FillModel)(0),                          // 2: xstockstrat.analysis.v1.FillModel
	(BarAction)(0),                          // 3: xstockstrat.analysis.v1.BarAction
	(NoTradeReason)(0),                      // 4: xstockstrat.analysis.v1.NoTradeReason
	(ComponentKind)(0),                      // 5: xstockstrat.analysis.v1.ComponentKind
	(StrategyOperation)(0),                  // 6: xstockstrat.analysis.v1.StrategyOperation
	(Comparator)(0),                         // 7: xstockstrat.analysis.v1.Comparator
	(ScreenKind)(0),                         // 8: xstockstrat.analysis.v1.ScreenKind
	(ScreenResultStatus)(0),                 // 9: xstockstrat.analysis.v1.ScreenResultStatus
	(OpportunityActionTag)(0),               // 10: xstockstrat.analysis.v1.OpportunityActionTag
	(ConditionState)(0),                     // 11: xstockstrat.analysis.v1.ConditionState
	(ReadinessRule)(0),                      // 12: xstockstrat.analysis.v1.ReadinessRule
	(ReadinessState)(0),                     // 13: xstockstrat.analysis.v1.ReadinessState
	(OpportunityAction)(0),                  // 14: xstockstrat.analysis.v1.OpportunityAction
	(SnapshotEventType)(0),                  // 15: xstockstrat.analysis.v1.SnapshotEventType
	(FactorType)(0),                         // 16: xstockstrat.analysis.v1.FactorType
	(*RunBacktestRequest)(nil),              // 17: xstockstrat.analysis.v1.RunBacktestRequest
	(*CoverageGap)(nil),                     // 18: xstockstrat.analysis.v1.CoverageGap
	(*BacktestResult)(nil),                  // 19: xstockstrat.analysis.v1.BacktestResult
	(*PortfolioCapitalSkip)(nil),            // 20: xstockstrat.analysis.v1.PortfolioCapitalSkip
	(*EquityPoint)(nil),                     // 21: xstockstrat.analysis.v1.EquityPoint
	(*TradeRecord)(nil),                     // 22: xstockstrat.analysis.v1.TradeRecord
	(*BarDiagnostic)(nil),                   // 23: xstockstrat.analysis.v1.BarDiagnostic
	(*SymbolDiagnostics)(nil),               // 24: xstockstrat.analysis.v1.SymbolDiagnostics
	(*ScoreStrategyRequest)(nil),            // 25: xstockstrat.analysis.v1.ScoreStrategyRequest
	(*StrategyScore)(nil),                   // 26: xstockstrat.analysis.v1.StrategyScore
	(*StrategyReport)(nil),                  // 27: xstockstrat.analysis.v1.StrategyReport
	(*ListBacktestsRequest)(nil),            // 28: xstockstrat.analysis.v1.ListBacktestsRequest
	(*BacktestRunSummary)(nil),              // 29: xstockstrat.analysis.v1.BacktestRunSummary
	(*ListBacktestsResponse)(nil),           // 30: xstockstrat.analysis.v1.ListBacktestsResponse
	(*GetBacktestRequest)(nil),              // 31: xstockstrat.analysis.v1.GetBacktestRequest
	(*ListStrategiesRequest)(nil),           // 32: xstockstrat.analysis.v1.ListStrategiesRequest
	(*ListStrategiesResponse)(nil),          // 33: xstockstrat.analysis.v1.ListStrategiesResponse
	(*GetStrategyReportRequest)(nil),        // 34: xstockstrat.analysis.v1.GetStrategyReportRequest
	(*StrategyComponent)(nil),               // 35: xstockstrat.analysis.v1.StrategyComponent
	(*StrategyDefinition)(nil),              // 36: xstockstrat.analysis.v1.StrategyDefinition
	(*ManageStrategyRequest)(nil),           // 37: xstockstrat.analysis.v1.ManageStrategyRequest
	(*GetStrategyRequest)(nil),              // 38: xstockstrat.analysis.v1.GetStrategyRequest
	(*ListStrategyDefinitionsRequest)(nil),  // 39: xstockstrat.analysis.v1.ListStrategyDefinitionsRequest
	(*ListStrategyDefinitionsResponse)(nil), // 40: xstockstrat.analysis.v1.ListStrategyDefinitionsResponse
	(*SetStrategyLiveRequest)(nil),          // 41: xstockstrat.analysis.v1.SetStrategyLiveRequest
	(*SetStrategyLiveResponse)(nil),         // 42: xstockstrat.analysis.v1.SetStrategyLiveResponse
	(*ScreenCriterion)(nil),                 // 43: xstockstrat.analysis.v1.ScreenCriterion
	(*ScreenResult)(nil),                    // 44: xstockstrat.analysis.v1.ScreenResult
	(*ScreenSymbolsRequest)(nil),            // 45: xstockstrat.analysis.v1.ScreenSymbolsRequest
	(*ScreenSymbolsResponse)(nil),           // 46: xstockstrat.analysis.v1.ScreenSymbolsResponse
	(*RunFundamentalsScanRequest)(nil),      // 47: xstockstrat.analysis.v1.RunFundamentalsScanRequest
	(*FundamentalsScanSummary)(nil),         // 48: xstockstrat.analysis.v1.FundamentalsScanSummary
	(*Opportunity)(nil),                     // 49: xstockstrat.analysis.v1.Opportunity
	(*SparklinePoint)(nil),                  // 50: xstockstrat.analysis.v1.SparklinePoint
	(*ConditionEval)(nil),                   // 51: xstockstrat.analysis.v1.ConditionEval
	(*SymbolReadiness)(nil),                 // 52: xstockstrat.analysis.v1.SymbolReadiness
	(*StrategyAnalytics)(nil),               // 53: xstockstrat.analysis.v1.StrategyAnalytics
	(*ListOpportunitiesRequest)(nil),        // 54: xstockstrat.analysis.v1.ListOpportunitiesRequest
	(*ListOpportunitiesResponse)(nil),       // 55: xstockstrat.analysis.v1.ListOpportunitiesResponse
	(*EvaluateReadinessRequest)(nil),        // 56: xstockstrat.analysis.v1.EvaluateReadinessRequest
	(*EvaluateReadinessResponse)(nil),       // 57: xstockstrat.analysis.v1.EvaluateReadinessResponse
	(*WatchlistReadinessRow)(nil),           // 58: xstockstrat.analysis.v1.WatchlistReadinessRow
	(*GetWatchlistReadinessRequest)(nil),    // 59: xstockstrat.analysis.v1.GetWatchlistReadinessRequest
	(*GetWatchlistReadinessResponse)(nil),   // 60: xstockstrat.analysis.v1.GetWatchlistReadinessResponse
	(*SetOpportunityActionRequest)(nil),     // 61: xstockstrat.analysis.v1.SetOpportunityActionRequest
	(*SetOpportunityActionResponse)(nil),    // 62: xstockstrat.analysis.v1.SetOpportunityActionResponse
	(*GetStrategyAnalyticsRequest)(nil),     // 63: xstockstrat.analysis.v1.GetStrategyAnalyticsRequest
	(*GetIndicatorSeriesRequest)(nil),       // 64: xstockstrat.analysis.v1.GetIndicatorSeriesRequest
	(*GetIndicatorSeriesResponse)(nil),      // 65: xstockstrat.analysis.v1.GetIndicatorSeriesResponse
	(*ComponentSeries)(nil),                 // 66: xstockstrat.analysis.v1.ComponentSeries
	(*NamedSeries)(nil),                     // 67: xstockstrat.analysis.v1.NamedSeries
	(*IndicatorValue)(nil),                  // 68: xstockstrat.analysis.v1.IndicatorValue
	(*SignalEntry)(nil),                     // 69: xstockstrat.analysis.v1.SignalEntry
	(*OrderSnapshot)(nil),                   // 70: xstockstrat.analysis.v1.OrderSnapshot
	(*PnLPatternFactor)(nil),                // 71: xstockstrat.analysis.v1.PnLPatternFactor
	(*QueryPnLPatternsRequest)(nil),         // 72: xstockstrat.analysis.v1.QueryPnLPatternsRequest
	(*QueryPnLPatternsResponse)(nil),        // 73: xstockstrat.analysis.v1.QueryPnLPatternsResponse
	(*GetAttributionRequest)(nil),           // 74: xstockstrat.analysis.v1.GetAttributionRequest
	(*SourceAttribution)(nil),               // 75: xstockstrat.analysis.v1.SourceAttribution
	(*GetAttributionResponse)(nil),          // 76: xstockstrat.analysis.v1.GetAttributionResponse
	nil,                                     // 77: xstockstrat.analysis.v1.BarDiagnostic.IndicatorsEntry
	nil,                                     // 78: xstockstrat.analysis.v1.StrategyScore.ComponentScoresEntry
	nil,                                     // 79: xstockstrat.analysis.v1.StrategyComponent.ParamsEntry
	nil,                                     // 80: xstockstrat.analysis.v1.ScreenResult.CriterionScoresEntry
	nil,                                     // 81: xstockstrat.analysis.v1.ScreenResult.CriterionRawValuesEntry
	nil,                                     // 82: xstockstrat.analysis.v1.ScreenResult.CriterionPassedEntry
	nil,                                     // 83: xstockstrat.analysis.v1.OrderSnapshot.IndicatorValuesEntry
	(*v1.TimeRange)(nil),                    // 84: xstockstrat.common.v1.TimeRange
	(*structpb.Struct)(nil),                 // 85: google.protobuf.Struct
	(v1.Timeframe)(0),                       // 86: xstockstrat.common.v1.Timeframe
	(*timestamppb.Timestamp)(nil),           // 87: google.protobuf.Timestamp
	(*v1.PageRequest)(nil),                  // 88: xstockstrat.common.v1.PageRequest
	(*v1.PageResponse)(nil),                 // 89: xstockstrat.common.v1.PageResponse
	(*fieldmaskpb.FieldMask)(nil),           // 90: google.protobuf.FieldMask
}
var file_analysis_v1_analysis_proto_depIdxs = []int32{
	84,  // 0: xstockstrat.analysis.v1.RunBacktestRequest.range:type_name -> xstockstrat.common.v1.TimeRange
	85,  // 1: xstockstrat.analysis.v1.RunBacktestRequest.strategy_params:type_name -> google.protobuf.Struct
	36,  // 2: xstockstrat.analysis.v1.RunBacktestRequest.inline_definition:type_name -> xstockstrat.analysis.v1.StrategyDefinition
	...
	86,  // 5: xstockstrat.analysis.v1.CoverageGap.timeframe:type_name -> xstockstrat.common.v1.Timeframe
	84,  // 6: xstockstrat.analysis.v1.CoverageGap.requested_range:type_name -> xstockstrat.common.v1.TimeRange
	84,  // 7: xstockstrat.analysis.v1.CoverageGap.gap:type_name -> xstockstrat.common.v1.TimeRange
	87,  // 8: xstockstrat.analysis.v1.BacktestResult.completed_at:type_name -> google.protobuf.Timestamp
	22,  // 9: xstockstrat.analysis.v1.BacktestResult.trades:type_name -> xstockstrat.analysis.v1.TradeRecord
	0,   // 10: xstockstrat.analysis.v1.BacktestResult.status:type_name -> xstockstrat.analysis.v1.BacktestStatus
	18,  // 11: xstockstrat.analysis.v1.BacktestResult.coverage_gaps:type_name -> xstockstrat.analysis.v1.CoverageGap
	24,  // 12: xstockstrat.analysis.v1.BacktestResult.diagnostics:type_name -> xstockstrat.analysis.v1.SymbolDiagnostics
	1,   // 13: xstockstrat.analysis.v1.BacktestResult.sizing_mode:type_name -> xstockstrat.analysis.v1.SizingMode
	20,  // 14: xstockstrat.analysis.v1.BacktestResult.capital_skips:type_name -> xstockstrat.analysis.v1.PortfolioCapitalSkip
	21,  // 15: xstockstrat.analysis.v1.BacktestResult.portfolio_equity_curve:type_name -> xstockstrat.analysis.v1.EquityPoint
	2,   // 16: xstockstrat.analysis.v1.BacktestResult.fill_model:type_name -> xstockstrat.analysis.v1.FillModel
	87,  // 17: xstockstrat.analysis.v1.PortfolioCapitalSkip.timestamp:type_name -> google.protobuf.Timestamp
	87,  // 18: xstockstrat.analysis.v1.EquityPoint.timestamp:type_name -> google.protobuf.Timestamp
	87,  // 19: xstockstrat.analysis.v1.TradeRecord.entry_time:type_name -> google.protobuf.Timestamp
	87,  // 20: xstockstrat.analysis.v1.TradeRecord.exit_time:type_name -> google.protobuf.Timestamp
	87,  // 21: xstockstrat.analysis.v1.BarDiagnostic.timestamp:type_name -> google.protobuf.Timestamp
	77,  // 22: xstockstrat.analysis.v1.BarDiagnostic.indicators:type_name -> xstockstrat.analysis.v1.BarDiagnostic.IndicatorsEntry
	3,   // 23: xstockstrat.analysis.v1.BarDiagnostic.action:type_name -> xstockstrat.analysis.v1.BarAction
	23,  // 24: xstockstrat.analysis.v1.SymbolDiagnostics.bars:type_name -> xstockstrat.analysis.v1.BarDiagnostic
	4,   // 25: xstockstrat.analysis.v1.SymbolDiagnostics.no_trade_reason:type_name -> xstockstrat.analysis.v1.NoTradeReason
	84,  // 26: xstockstrat.analysis.v1.ScoreStrategyRequest.range:type_name -> xstockstrat.common.v1.TimeRange
	78,  // 27: xstockstrat.analysis.v1.StrategyScore.component_scores:type_name -> xstockstrat.analysis.v1.StrategyScore.ComponentScoresEntry
	19,  // 28: xstockstrat.analysis.v1.StrategyReport.latest_backtest:type_name -> xstockstrat.analysis.v1.BacktestResult
	26,  // 29: xstockstrat.analysis.v1.StrategyReport.score:type_name -> xstockstrat.analysis.v1.StrategyScore
	85,  // 30: xstockstrat.analysis.v1.StrategyReport.metadata:type_name -> google.protobuf.Struct
	0,   // 31: xstockstrat.analysis.v1.BacktestRunSummary.status:type_name -> xstockstrat.analysis.v1.BacktestStatus
	87,  // 32: xstockstrat.analysis.v1.BacktestRunSummary.completed_at:type_name -> google.protobuf.Timestamp
	87,  // 33: xstockstrat.analysis.v1.BacktestRunSummary.range_start:type_name -> google.protobuf.Timestamp
	87,  // 34: xstockstrat.analysis.v1.BacktestRunSummary.range_end:type_name -> google.protobuf.Timestamp
	...
	29,  // 37: xstockstrat.analysis.v1.ListBacktestsResponse.runs:type_name -> xstockstrat.analysis.v1.BacktestRunSummary
	88,  // 38: xstockstrat.analysis.v1.ListStrategiesRequest.page:type_name -> xstockstrat.common.v1.PageRequest
	26,  // 39: xstockstrat.analysis.v1.ListStrategiesResponse.strategies:type_name -> xstockstrat.analysis.v1.StrategyScore
	89,  // 40: xstockstrat.analysis.v1.ListStrategiesResponse.page:type_name -> xstockstrat.common.v1.PageResponse
	5,   // 41: xstockstrat.analysis.v1.StrategyComponent.kind:type_name -> xstockstrat.analysis.v1.ComponentKind
	79,  // 42: xstockstrat.analysis.v1.StrategyComponent.params:type_name -> xstockstrat.analysis.v1.StrategyComponent.ParamsEntry
	35,  // 43: xstockstrat.analysis.v1.StrategyDefinition.components:type_name -> xstockstrat.analysis.v1.StrategyComponent
	85,  // 44: xstockstrat.analysis.v1.StrategyDefinition.signal_params:type_name -> google.protobuf.Struct
	6,   // 45: xstockstrat.analysis.v1.ManageStrategyRequest.operation:type_name -> xstockstrat.analysis.v1.StrategyOperation
	36,  // 46: xstockstrat.analysis.v1.ManageStrategyRequest.definition:type_name -> xstockstrat.analysis.v1.StrategyDefinition
	90,  // 47: xstockstrat.analysis.v1.ManageStrategyRequest.update_mask:type_name -> google.protobuf.FieldMask
	36,  // 48: xstockstrat.analysis.v1.ListStrategyDefinitionsResponse.definitions:type_name -> xstockstrat.analysis.v1.StrategyDefinition
	36,  // 49: xstockstrat.analysis.v1.SetStrategyLiveResponse.definition:type_name -> xstockstrat.analysis.v1.StrategyDefinition
	8,   // 50: xstockstrat.analysis.v1.ScreenCriterion.kind:type_name -> xstockstrat.analysis.v1.ScreenKind
	35,  // 51: xstockstrat.analysis.v1.ScreenCriterion.component:type_name -> xstockstrat.analysis.v1.StrategyComponent
	7,   // 52: xstockstrat.analysis.v1.ScreenCriterion.op:type_name -> xstockstrat.analysis.v1.Comparator
	80,  // 53: xstockstrat.analysis.v1.ScreenResult.criterion_scores:type_name -> xstockstrat.analysis.v1.ScreenResult.CriterionScoresEntry
	9,   // 54: xstockstrat.analysis.v1.ScreenResult.status:type_name -> xstockstrat.analysis.v1.ScreenResultStatus
	18,  // 55: xstockstrat.analysis.v1.ScreenResult.gap:type_name -> xstockstrat.analysis.v1.CoverageGap
	81,  // 56: xstockstrat.analysis.v1.ScreenResult.criterion_raw_values:type_name -> xstockstrat.analysis.v1.ScreenResult.CriterionRawValuesEntry
	82,  // 57: xstockstrat.analysis.v1.ScreenResult.criterion_passed:type_name -> xstockstrat.analysis.v1.ScreenResult.CriterionPassedEntry
	43,  // 58: xstockstrat.analysis.v1.ScreenSymbolsRequest.criteria:type_name -> xstockstrat.analysis.v1.ScreenCriterion
	84,  // 59: xstockstrat.analysis.v1.ScreenSymbolsRequest.evaluation_window:type_name -> xstockstrat.common.v1.TimeRange
	44,  // 60: xstockstrat.analysis.v1.ScreenSymbolsResponse.results:type_name -> xstockstrat.analysis.v1.ScreenResult
	18,  // 61: xstockstrat.analysis.v1.ScreenSymbolsResponse.coverage_gaps:type_name -> xstockstrat.analysis.v1.CoverageGap
	87,  // 62: xstockstrat.analysis.v1.FundamentalsScanSummary.finished_at:type_name -> google.protobuf.Timestamp
	10,  // 63: xstockstrat.analysis.v1.Opportunity.action:type_name -> xstockstrat.analysis.v1.OpportunityActionTag
	87,  // 64: xstockstrat.analysis.v1.Opportunity.valid_until:type_name -> google.protobuf.Timestamp
	50,  // 65: xstockstrat.analysis.v1.Opportunity.sparkline:type_name -> xstockstrat.analysis.v1.SparklinePoint
	51,  // 66: xstockstrat.analysis.v1.Opportunity.conditions:type_name -> xstockstrat.analysis.v1.ConditionEval
	11,  // 67: xstockstrat.analysis.v1.ConditionEval.state:type_name -> xstockstrat.analysis.v1.ConditionState
	51,  // 68: xstockstrat.analysis.v1.SymbolReadiness.conditions:type_name -> xstockstrat.analysis.v1.ConditionEval
	88,  // 69: xstockstrat.analysis.v1.ListOpportunitiesRequest.page:type_name -> xstockstrat.common.v1.PageRequest
	49,  // 70: xstockstrat.analysis.v1.ListOpportunitiesResponse.opportunities:type_name -> xstockstrat.analysis.v1.Opportunity
	89,  // 71: xstockstrat.analysis.v1.ListOpportunitiesResponse.page:type_name -> xstockstrat.common.v1.PageResponse
	12,  // 72: xstockstrat.analysis.v1.EvaluateReadinessRequest.rule:type_name -> xstockstrat.analysis.v1.ReadinessRule
	52,  // 73: xstockstrat.analysis.v1.EvaluateReadinessResponse.readiness:type_name -> xstockstrat.analysis.v1.SymbolReadiness
	87,  // 74: xstockstrat.analysis.v1.EvaluateReadinessResponse.computed_at:type_name -> google.protobuf.Timestamp
	13,  // 75: xstockstrat.analysis.v1.WatchlistReadinessRow.state:type_name -> xstockstrat.analysis.v1.ReadinessState
	52,  // 76: xstockstrat.analysis.v1.WatchlistReadinessRow.readiness:type_name -> xstockstrat.analysis.v1.SymbolReadiness
	87,  // 77: xstockstrat.analysis.v1.WatchlistReadinessRow.computed_at:type_name -> google.protobuf.Timestamp
	88,  // 78: xstockstrat.analysis.v1.GetWatchlistReadinessRequest.page:type_name -> xstockstrat.common.v1.PageRequest
	58,  // 79: xstockstrat.analysis.v1.GetWatchlistReadinessResponse.rows:type_name -> xstockstrat.analysis.v1.WatchlistReadinessRow
	89,  // 80: xstockstrat.analysis.v1.GetWatchlistReadinessResponse.page:type_name -> xstockstrat.common.v1.PageResponse
	14,  // 81: xstockstrat.analysis.v1.SetOpportunityActionRequest.action:type_name -> xstockstrat.analysis.v1.OpportunityAction
	87,  // 82: xstockstrat.analysis.v1.SetOpportunityActionRequest.snooze_until:type_name -> google.protobuf.Timestamp
	87,  // 83: xstockstrat.analysis.v1.GetIndicatorSeriesRequest.times:type_name -> google.protobuf.Timestamp
	87,  // 84: xstockstrat.analysis.v1.GetIndicatorSeriesResponse.times:type_name -> google.protobuf.Timestamp
	66,  // 85: xstockstrat.analysis.v1.GetIndicatorSeriesResponse.components:type_name -> xstockstrat.analysis.v1.ComponentSeries
	5,   // 86: xstockstrat.analysis.v1.ComponentSeries.kind:type_name -> xstockstrat.analysis.v1.ComponentKind
	67,  // 87: xstockstrat.analysis.v1.ComponentSeries.series:type_name -> xstockstrat.analysis.v1.NamedSeries
	68,  // 88: xstockstrat.analysis.v1.NamedSeries.values:type_name -> xstockstrat.analysis.v1.IndicatorValue
	15,  // 89: xstockstrat.analysis.v1.OrderSnapshot.event_type:type_name -> xstockstrat.analysis.v1.SnapshotEventType
	87,  // 90: xstockstrat.analysis.v1.OrderSnapshot.event_ts:type_name -> google.protobuf.Timestamp
	85,  // 91: xstockstrat.analysis.v1.OrderSnapshot.ohlcv_bar:type_name -> google.protobuf.Struct
	83,  // 92: xstockstrat.analysis.v1.OrderSnapshot.indicator_values:type_name -> xstockstrat.analysis.v1.OrderSnapshot.IndicatorValuesEntry
	69,  // 93: xstockstrat.analysis.v1.OrderSnapshot.signals:type_name -> xstockstrat.analysis.v1.SignalEntry
	16,  // 94: xstockstrat.analysis.v1.PnLPatternFactor.factor_type:type_name -> xstockstrat.analysis.v1.FactorType
	87,  // 95: xstockstrat.analysis.v1.QueryPnLPatternsRequest.from_ts:type_name -> google.protobuf.Timestamp
	87,  // 96: xstockstrat.analysis.v1.QueryPnLPatternsRequest.to_ts:type_name -> google.protobuf.Timestamp
	71,  // 97: xstockstrat.analysis.v1.QueryPnLPatternsResponse.positive_factors:type_name -> xstockstrat.analysis.v1.PnLPatternFactor
	71,  // 98: xstockstrat.analysis.v1.QueryPnLPatternsResponse.negative_factors:type_name -> xstockstrat.analysis.v1.PnLPatternFactor
	87,  // 99: xstockstrat.analysis.v1.GetAttributionRequest.start:type_name -> google.protobuf.Timestamp
	87,  // 100: xstockstrat.analysis.v1.GetAttributionRequest.end:type_name -> google.protobuf.Timestamp
	75,  // 101: xstockstrat.analysis.v1.GetAttributionResponse.attributions:type_name -> xstockstrat.analysis.v1.SourceAttribution
	17,  // 102: xstockstrat.analysis.v1.AnalysisService.RunBacktest:input_type -> xstockstrat.analysis.v1.RunBacktestRequest
	25,  // 103: xstockstrat.analysis.v1.AnalysisService.ScoreStrategy:input_type -> xstockstrat.analysis.v1.ScoreStrategyRequest
	32,  // 104: xstockstrat.analysis.v1.AnalysisService.ListStrategies:input_type -> xstockstrat.analysis.v1.ListStrategiesRequest
	34,  // 105: xstockstrat.analysis.v1.AnalysisService.GetStrategyReport:input_type -> xstockstrat.analysis.v1.GetStrategyReportRequest
	28,  // 106: xstockstrat.analysis.v1.AnalysisService.ListBacktests:input_type -> xstockstrat.analysis.v1.ListBacktestsRequest
	31,  // 107: xstockstrat.analysis.v1.AnalysisService.GetBacktest:input_type -> xstockstrat.analysis.v1.GetBacktestRequest
	37,  // 108: xstockstrat.analysis.v1.AnalysisService.ManageStrategy:input_type -> xstockstrat.analysis.v1.ManageStrategyRequest
	38,  // 109: xstockstrat.analysis.v1.AnalysisService.GetStrategy:input_type -> xstockstrat.analysis.v1.GetStrategyRequest
	39,  // 110: xstockstrat.analysis.v1.AnalysisService.ListStrategyDefinitions:input_type -> xstockstrat.analysis.v1.ListStrategyDefinitionsRequest
	41,  // 111: xstockstrat.analysis.v1.AnalysisService.SetStrategyLive:input_type -> xstockstrat.analysis.v1.SetStrategyLiveRequest
	45,  // 112: xstockstrat.analysis.v1.AnalysisService.ScreenSymbols:input_type -> xstockstrat.analysis.v1.ScreenSymbolsRequest
	47,  // 113: xstockstrat.analysis.v1.AnalysisService.RunFundamentalsScan:input_type -> xstockstrat.analysis.v1.RunFundamentalsScanRequest
	54,  // 114: xstockstrat.analysis.v1.AnalysisService.ListOpportunities:input_type -> xstockstrat.analysis.v1.ListOpportunitiesRequest
	56,  // 115: xstockstrat.analysis.v1.AnalysisService.EvaluateReadiness:input_type -> xstockstrat.analysis.v1.EvaluateReadinessRequest
	61,  // 116: xstockstrat.analysis.v1.AnalysisService.SetOpportunityAction:input_type -> xstockstrat.analysis.v1.SetOpportunityActionRequest
	63,  // 117: xstockstrat.analysis.v1.AnalysisService.GetStrategyAnalytics:input_type -> xstockstrat.analysis.v1.GetStrategyAnalyticsRequest
	64,  // 118: xstockstrat.analysis.v1.AnalysisService.GetIndicatorSeries:input_type -> xstockstrat.analysis.v1.GetIndicatorSeriesRequest
	72,  // 119: xstockstrat.analysis.v1.AnalysisService.QueryPnLPatterns:input_type -> xstockstrat.analysis.v1.QueryPnLPatternsRequest
	74,  // 120: xstockstrat.analysis.v1.AnalysisService.GetAttribution:input_type -> xstockstrat.analysis.v1.GetAttributionRequest
	59,  // 121: xstockstrat.analysis.v1.AnalysisService.GetWatchlistReadiness:input_type -> xstockstrat.analysis.v1.GetWatchlistReadinessRequest
	19,  // 122: xstockstrat.analysis.v1.AnalysisService.RunBacktest:output_type -> xstockstrat.analysis.v1.BacktestResult
	26,  // 123: xstockstrat.analysis.v1.AnalysisService.ScoreStrategy:output_type -> xstockstrat.analysis.v1.StrategyScore
	33,  // 124: xstockstrat.analysis.v1.AnalysisService.ListStrategies:output_type -> xstockstrat.analysis.v1.ListStrategiesResponse
	27,  // 125: xstockstrat.analysis.v1.AnalysisService.GetStrategyReport:output_type -> xstockstrat.analysis.v1.StrategyReport
	30,  // 126: xstockstrat.analysis.v1.AnalysisService.ListBacktests:output_type -> xstockstrat.analysis.v1.ListBacktestsResponse
	19,  // 127: xstockstrat.analysis.v1.AnalysisService.GetBacktest:output_type -> xstockstrat.analysis.v1.BacktestResult
	36,  // 128: xstockstrat.analysis.v1.AnalysisService.ManageStrategy:output_type -> xstockstrat.analysis.v1.StrategyDefinition
	36,  // 129: xstockstrat.analysis.v1.AnalysisService.GetStrategy:output_type -> xstockstrat.analysis.v1.StrategyDefinition
	40,  // 130: xstockstrat.analysis.v1.AnalysisService.ListStrategyDefinitions:output_type -> xstockstrat.analysis.v1.ListStrategyDefinitionsResponse
	42,  // 131: xstockstrat.analysis.v1.AnalysisService.SetStrategyLive:output_type -> xstockstrat.analysis.v1.SetStrategyLiveResponse
	46,  // 132: xstockstrat.analysis.v1.AnalysisService.ScreenSymbols:output_type -> xstockstrat.analysis.v1.ScreenSymbolsResponse
	48,  // 133: xstockstrat.analysis.v1.AnalysisService.RunFundamentalsScan:output_type -> xstockstrat.analysis.v1.FundamentalsScanSummary
	55,  // 134: xstockstrat.analysis.v1.AnalysisService.ListOpportunities:output_type -> xstockstrat.analysis.v1.ListOpportunitiesResponse
	57,  // 135: xstockstrat.analysis.v1.AnalysisService.EvaluateReadiness:output_type -> xstockstrat.analysis.v1.EvaluateReadinessResponse
	62,  // 136: xstockstrat.analysis.v1.AnalysisService.SetOpportunityAction:output_type -> xstockstrat.analysis.v1.SetOpportunityActionResponse
	53,  // 137: xstockstrat.analysis.v1.AnalysisService.GetStrategyAnalytics:output_type -> xstockstrat.analysis.v1.StrategyAnalytics
	65,  // 138: xstockstrat.analysis.v1.AnalysisService.GetIndicatorSeries:output_type -> xstockstrat.analysis.v1.GetIndicatorSeriesResponse
	73,  // 139: xstockstrat.analysis.v1.AnalysisService.QueryPnLPatterns:output_type -> xstockstrat.analysis.v1.QueryPnLPatternsResponse
	76,  // 140: xstockstrat.analysis.v1.AnalysisService.GetAttribution:output_type -> xstockstrat.analysis.v1.GetAttributionResponse
	60,  // 141: xstockstrat.analysis.v1.AnalysisService.GetWatchlistReadiness:output_type -> xstockstrat.analysis.v1.GetWatchlistReadinessResponse
