...
func (c *ingestServiceClient) IngestSignal(ctx context.Context, in *IngestSignalRequest, opts ...grpc.CallOption) (*IngestSignalResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IngestSignalResponse)
	err := c.cc.Invoke(ctx, IngestService_IngestSignal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ingestServiceClient) QuerySignals(ctx context.Context, in *QuerySignalsRequest, opts ...grpc.CallOption) (*QuerySignalsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QuerySignalsResponse)
	err := c.cc.Invoke(ctx, IngestService_QuerySignals_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ingestServiceClient) ListSignalSources(ctx context.Context, in *ListSignalSourcesRequest, opts ...grpc.CallOption) (*ListSignalSourcesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListSignalSourcesResponse)
	err := c.cc.Invoke(ctx, IngestService_ListSignalSources_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *ingestServiceClient) ManageSignalSource(ctx context.Context, in *ManageSignalSourceRequest, opts ...grpc.CallOption) (*ManageSignalSourceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ManageSignalSourceResponse)
	err := c.cc.Invoke(ctx, IngestService_ManageSignalSource_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIngestServiceServer) IngestSignal(context.Context, *IngestSignalRequest) (*IngestSignalResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IngestSignal not implemented")
}
func (UnimplementedIngestServiceServer) QuerySignals(context.Context, *QuerySignalsRequest) (*QuerySignalsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method QuerySignals not implemented")
}
func (UnimplementedIngestServiceServer) ListSignalSources(context.Context, *ListSignalSourcesRequest) (*ListSignalSourcesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListSignalSources not implemented")
}
...
func _IngestService_IngestSignal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IngestSignalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IngestServiceServer).IngestSignal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IngestService_IngestSignal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngestServiceServer).IngestSignal(ctx, req.(*IngestSignalRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _IngestService_QuerySignals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QuerySignalsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IngestServiceServer).QuerySignals(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IngestService_QuerySignals_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngestServiceServer).QuerySignals(ctx, req.(*QuerySignalsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _IngestService_ListSignalSources_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListSignalSourcesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IngestServiceServer).ListSignalSources(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IngestService_ListSignalSources_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngestServiceServer).ListSignalSources(ctx, req.(*ListSignalSourcesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _IngestService_ManageSignalSource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ManageSignalSourceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IngestServiceServer).ManageSignalSource(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IngestService_ManageSignalSource_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngestServiceServer).ManageSignalSource(ctx, req.(*ManageSignalSourceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IngestService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _IngestService_IngestSignal_Handler,
		},
		{
			MethodName: "QuerySignals",
			Handler:    _IngestService_QuerySignals_Handler,
		},
		{
			MethodName: "ListSignalSources",
			Handler:    _IngestService_ListSignalSources_Handler,
		},
		{
