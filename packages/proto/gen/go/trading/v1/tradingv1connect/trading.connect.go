...
func NewTradingServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TradingServiceClient {
	...
	return &tradingServiceClient{
		...
		replaceOrder: connect.NewClient[v1.ReplaceOrderRequest, v1.Order](
			httpClient,
			baseURL+TradingServiceReplaceOrderProcedure,
...
func NewTradingServiceHandler(svc TradingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	tradingServiceReplaceOrderHandler := connect.NewUnaryHandler(
		TradingServiceReplaceOrderProcedure,
		svc.ReplaceOrder,
		connect.WithSchema(tradingServiceMethods.ByName("ReplaceOrder")),
		connect.WithHandlerOptions(opts...),
	)
