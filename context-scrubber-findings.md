...
| root `CLAUDE.md:119` | "golangci-lint ... run via `golangci-lint-action@v6`" | CI (`.github/workflows/ci.yml:223`) now pins `@v9` | ✅ **APPLIED** — CLAUDE.md re-grounded to `@v9` to match CI |
...
| root `CLAUDE.md:119` | "run via `golangci-lint-action@v6`" | `.github/workflows/ci.yml:223` pins `@v9` | ✅ **APPLIED** — citation fixed to `@v9` (the `v2.5.0` linter-version pin itself is correct) |
