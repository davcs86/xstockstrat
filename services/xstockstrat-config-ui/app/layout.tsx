      ...
      <body className="min-h-screen bg-background font-sans antialiased">
        <header className="sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur-sm">
          <div className="flex h-14 items-center gap-4 px-4 sm:px-6">
            ...
            {/* Platform nav — /trader and /insights are cross-app links (different basePath); <a> is required */}
            <nav className="hidden sm:flex items-center gap-1">
              ...
              <Link href="/" className="flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm bg-accent text-foreground font-medium transition-colors">
