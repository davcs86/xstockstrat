      ...
      <body className="min-h-screen bg-background font-sans antialiased">
        <header className="sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur-sm">
          <div className="flex h-14 items-center gap-4 px-4 sm:px-6">
            {/* Logo */}
            <a href="/config-ui" className="flex items-center gap-2 text-primary font-semibold shrink-0">
            ...
            <nav className="hidden sm:flex items-center gap-1">
              <a href="/trader" className="flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm text-muted-foreground hover:text-foreground hover:bg-accent/50 transition-colors">
              ...
              <a href="/insights" className="flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm text-muted-foreground hover:text-foreground hover:bg-accent/50 transition-colors">
              ...
              <a href="/config-ui" className="flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm bg-accent text-foreground font-medium transition-colors">
