Feature: Signal-weighted screening reads the correct bar-time proto field (feature 159)
  Regression guard promoted from feature 159's acceptance scenarios: signal-weighted
