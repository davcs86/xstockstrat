# Promoted business-rule suite for xstockstrat-analysis (Constitution C-16). Promoted from feature 152's
# acceptance.feature at launch; @feature-152 marks provenance. Do not hand-author or rewrite.
