# Promoted from docs/roadmap/features/168-fundamentals-blend-universe/acceptance.feature at launch
# (Constitution C-16). Source-feature provenance is carried on every scenario's `@feature-168` tag.
# Durable business rules xstockstrat-analysis guarantees for the fundamentals-blend universe
# resolution in the live evaluation loop — which symbols the blend strategy evaluates and which
# it excludes, config retargeting, and failure degradation.
...
Feature: fundamentals-blend-universe
  ...
  @AC-1 @FR-1 @FR-3 @FR-4 @feature-168
