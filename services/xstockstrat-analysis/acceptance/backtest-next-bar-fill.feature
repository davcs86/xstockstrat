# Promoted business-rule suite for xstockstrat-analysis (Constitution C-16). Promoted from feature 151's
# acceptance.feature at launch; @feature-151 marks provenance. Do not hand-author or rewrite.

Feature: backtest-next-bar-fill (analysis)
  Durable acceptance guarantees for next-bar-open backtest fills.

  @AC-1 @FR-1 @feature-151
