# Promoted from docs/roadmap/features/020-notify-external-fanout/acceptance.feature at launch
# (Constitution C-16). Source-feature provenance is carried on every scenario's `@feature-020` tag.
