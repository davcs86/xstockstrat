...
const nextConfig = {
  ...
  serverExternalPackages: ['@connectrpc/connect', '@connectrpc/connect-next', '@connectrpc/connect-node', '@bufbuild/protobuf', '@opentelemetry/sdk-node', '@opentelemetry/exporter-trace-otlp-http'],
};
