/**
 * Shared ConfigWatcher for all Node.js services — subscribes to the xstockstrat-config WatchConfig
...
export class ConfigWatcher extends EventEmitter {
  ...
  private startWatch() {
    // Config is scoped by environment (production/staging) × global/per-user. paper/live is derived
    // from environment; trading_mode is deprecated and ignored by the server.
