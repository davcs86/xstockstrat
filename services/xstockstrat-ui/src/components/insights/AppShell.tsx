    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur-sm">
        <div className="flex h-14 items-center gap-4 px-4 sm:px-6">
          {/* Logo */}
          <Link href="/insights" className="flex items-center gap-2 text-primary font-semibold shrink-0">
          ...
          <nav className="hidden sm:flex items-center gap-1 flex-1">
            ...
            <Link
              href="/insights/strategies"
              className={cn(
                'px-3 py-1.5 rounded-md text-sm transition-colors',
                pathname?.startsWith('/insights/strategies')
                  ? 'text-foreground font-medium'
                  : 'text-muted-foreground hover:text-foreground hover:bg-accent/50',
              )}
            >
            ...
            <Sheet>
              ...
              <SheetContent side="left">
                ...
                <nav className="mt-6 flex flex-col gap-1">
                  ...
                  <Link href="/insights" className={cn('px-3 py-2.5 rounded-md text-sm transition-colors', pathname === '/insights' ? 'bg-accent text-foreground font-medium' : 'text-muted-foreground hover:text-foreground hover:bg-accent/50')}>
                    Dashboard
                  </Link>
