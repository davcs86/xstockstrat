...
// Admin-scoped manual trigger for the fundamentals signal producer. The BFF route is gated by
// forwardAdmin, so a non-admin caller surfaces a ConnectError (PermissionDenied) here.
