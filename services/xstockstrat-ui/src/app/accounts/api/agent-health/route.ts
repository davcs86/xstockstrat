...
// GET /accounts/api/agent-health — server-side probe of the MCP agent's OAuth discovery endpoint.
// Returns only reachability/status, never the payload; any fetch failure returns { reachable: false } (HTTP 200).
