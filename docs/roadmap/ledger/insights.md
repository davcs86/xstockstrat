...
- **Evidence**: `docs/roadmap/features/198-opportunity-composite-score/design.md` (Chosen Approach + Rejected Alternatives); recon `servicer.py:5187-5210` (EB shape), `:4094` (signal_axis MAX), `:667` (technical boundary); `fails.md:313`/`:418` (the ordinal-as-cardinal family this discharges).
