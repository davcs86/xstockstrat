...
- **Evidence**: `docs/roadmap/features/211-edgar-fundamentals-enrichment/design.md` § Rejected Alternatives (PIT-only "(Y)"), § Chosen Approach steps 1/3; `services/xstockstrat-marketdata/internal/edgar/edgar_client.go:335-339` (ROE ending-equity), `:341-346` (D/E), `:317` (hardcoded USD).
