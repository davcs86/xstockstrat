...
**Feature**: `docs/roadmap/features/173-quote-fanout-batching/feature.md`
**Product Spec**: `docs/roadmap/features/173-quote-fanout-batching/product-spec.md`
**Implementation Spec**: `docs/roadmap/features/173-quote-fanout-batching/implementation-spec.md`
...
- Lower-risk than 171/172: adopts an existing batch RPC (`GetLatestQuotesMulti`) and rewrites two
...
- Independent of 171/172 and can be sequenced in parallel; grouped separately to keep the Go portfolio
