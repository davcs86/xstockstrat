...
reviewers across all 9 steps. Re-run /sdd-spec if the registry changes.)_
...
| `xstockstrat-ui` (service owner) | Connect-RPC call safety, environment scope correctness, no secret values rendered in UI | 1, 2, 6, 7, 8 |
