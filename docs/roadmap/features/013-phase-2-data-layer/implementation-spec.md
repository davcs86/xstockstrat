...
5. Add `TestRealizedPnL_PartialFills` — four fill events for the same symbol instead of one: buy +50@50, buy +50@50, sell -50@70, sell -50@70 (two partial buy events + two partial sell events, equivalent to buy 100@50 and sell 100@70) → realized == 2000.0. This verifies that partial fills processed individually produce the same result as a single aggregate fill.
