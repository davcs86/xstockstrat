...
_Note: This is the stable reviewer snapshot generated by /sdd-spec on 2026-05-22. Re-run /sdd-spec to pick up registry changes._

## Next Action

Merge integration PR to `main-dev`, then run `/promote` when ready for production.
