...
- Website extraction tools for `mediated_simple_website` and `mediated_authenticated_website` — these types are registered in 008 but Claude-mediated website processing belongs to a future phase.
