...
| 2026-08-31 | archived | /sdd-archiver | Synthesis distilled to context.md + Ledger (2 insights, 2 fails); scenarios promoted to services/xstockstrat-agent/, services/xstockstrat-ui/, services/xstockstrat-config/acceptance/; product-spec.md, recon.md, design.md, implementation-spec.md pruned (recoverable from git) |
---
