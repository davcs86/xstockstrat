...
| File | Purpose |
|---|---|
| `implementation-roadmap.md` | Full platform implementation plan across 8 phases (Phase 0 foundation → Phase 7 observability). Includes per-phase service specs, verification checkpoints, and the dependency graph. Phases 1, 3, 4, 5, 6, 7 are marked DONE. |
...
**Pending phases:** Phase 0 (foundation setup), Phase 2 (data layer: marketdata + portfolio). See `implementation-roadmap.md` for full specs.
