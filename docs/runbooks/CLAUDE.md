...
| `mcp-tools.md` | MCP tool reference — all eleven agent tools with parameter tables, return shapes, error cases, transport modes, and x-mcp-secret enforcement | Using or troubleshooting the agent MCP server |
