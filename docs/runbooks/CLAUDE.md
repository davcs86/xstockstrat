...
| `mcp-tools.md` | MCP tool reference — all twenty-two agent tools with parameter tables, return shapes, error cases, transport modes, and OAuth 2.1 edge auth | Using or troubleshooting the agent MCP server |
