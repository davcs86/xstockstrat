...
```shell
python3 plugins/mcp-tools-docs/scripts/generate.py          # rewrite the skill from the runbook
python3 plugins/mcp-tools-docs/scripts/generate.py --check   # fail (exit 1) if the skill is stale
```
...
```shell
python3 plugins/mcp-tools-docs/scripts/validate.py --self-test
python3 plugins/mcp-tools-docs/scripts/validate.py
```
