...
> `plugins/sdd-suite/skills/sdd-review/reference/product-spec-criteria.md` (core criteria + trading-domain
...
> `plugins/sdd-suite/skills/sdd-review/reference/overlap-check.md` for the feature under review
...
> `plugins/sdd-suite/skills/sdd-review/reference/impl-spec-criteria.md` (B2 quality, B2b trading-domain,
...
> `plugins/sdd-suite/skills/sdd-review/reference/overlap-check.md` for `$FEATURE_DIR`. Return the
