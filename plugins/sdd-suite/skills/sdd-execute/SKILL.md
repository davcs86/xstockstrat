...
3. **Build the integration PR body** by rendering `plugins/sdd-suite/skills/sdd-execute/templates/integration-pr-body.md`
...
Read `plugins/sdd-suite/skills/sdd-execute/templates/branch-sync.md` and execute the procedure,
...
Read `plugins/sdd-suite/skills/sdd-execute/templates/step-pr-body.md` for the PR body template.
...
5. Create PR (use the filled-in body from the template):
   ...
   gh pr create \
     ...
     --body "$(cat plugins/sdd-suite/skills/sdd-execute/templates/step-pr-body.md)"
   ```
