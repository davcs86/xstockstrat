...
`plugins/sdd-suite/skills/sdd-execute/reference/tdd-gate.md`.
...
failing run before the implementation step and the passing run after (`plugins/sdd-suite/skills/sdd-execute/reference/tdd-gate.md`). Both
