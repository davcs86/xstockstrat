...
(format: `plugins/sdd-suite/skills/sdd-qa/reference/defect-filing.md`).
...
report violates its own format (`plugins/sdd-suite/skills/sdd-qa/reference/defect-filing.md`) — stop and fix
